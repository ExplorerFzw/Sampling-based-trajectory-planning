...
VehRearAxleCenterPoint_X(VehPositionRecordIndex) = carinitpos.x;
VehRearAxleCenterPoint_Y(VehPositionRecordIndex) = carinitpos.y;
VehRearAxleCenterPoint_Yaw(VehPositionRecordIndex) = carinitpos.theta;
