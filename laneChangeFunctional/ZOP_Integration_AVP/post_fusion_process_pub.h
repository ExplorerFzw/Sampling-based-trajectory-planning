...
* All rights reserved.
*******************************************************************************
* File name     : post_fusion_process_pub.h
* Description   :
* Version       : v1.0
...
#ifndef __H_POST_FUSION_PROCESS_PUB__
#define __H_POST_FUSION_PROCESS_PUB__
...
/*******************************************************************************
* @name        FusionTrackManager_PostFusionProcess_DeInit_V
* @brief
* @param[in]   none
* @param[out]  none
* @return      ZONE_RETURN_OK: success
...
/*******************************************************************************
* @name        FusionTrackManager_PostFusionProcess_Run_V
* @brief
* @param[in]   none
* @param[out]  none
* @return      ZONE_RETURN_OK: success
...
#endif /* __H_POST_FUSION_PROCESS_PUB__ */
