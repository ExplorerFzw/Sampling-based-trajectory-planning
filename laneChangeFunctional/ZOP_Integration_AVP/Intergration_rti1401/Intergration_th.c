/************************ dSPACE target specific file *************************
   ...
   Include file .\Intergration_rti1401\Intergration_th.c :

   Task Configuration file for model : Intergration

   RTI1401 7.12 (02-May-2019)/2.18
   11-Dec-2020 09:12:55
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Intergration_rti1401\Intergration_th.c is for ST).
# endif
