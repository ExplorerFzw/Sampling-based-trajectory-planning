...
#ifndef DEFINED_TYPEDEF_FOR_ACC_FOC_INFO_ST_
#define DEFINED_TYPEDEF_FOR_ACC_FOC_INFO_ST_
...
typedef struct {
  ...
  real32_T aStat;
  real32_T aApproach;
  real32_T ApproachCase;
  real32_T tObjStop;
  real32_T dSlowDown;
  boolean_T ObjLeaving;
  real32_T dImmerseAdj;
} ACC_FOC_INFO_ST;
...
typedef struct P_IfActionSubsystem_AccTarS_k_T_ P_IfActionSubsystem_AccTarS_k_T;
...
typedef struct P_IfActionSubsystem_AccTarS_g_T_ P_IfActionSubsystem_AccTarS_g_T;
