...
/* Block signals for system '<S243>/signal_sustain' */
#ifndef LCK_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T sustain_value;              /* '<S243>/signal_sustain' */
} B_signal_sustain_LCK_T;

#endif                                 /*LCK_MDLREF_HIDE_CHILD_*/

/* Block states (default storage) for system '<S243>/signal_sustain' */
#ifndef LCK_MDLREF_HIDE_CHILD_

typedef struct {
  real32_T i;                          /* '<S243>/signal_sustain' */
  uint8_T is_active_c106_sMO8bLBWfTvOHfGk;/* '<S243>/signal_sustain' */
  uint8_T is_c106_sMO8bLBWfTvOHfGkBHxhSIH;/* '<S243>/signal_sustain' */
...
typedef struct {
  ...
  real_T Delay;                        /* '<S244>/Delay' */
  real_T Switch2;                      /* '<S237>/Switch2' */
  real_T Switch1;                      /* '<S237>/Switch1' */
  real_T Switch;                       /* '<S237>/Switch' */
  real_T Delay1_k;                     /* '<S244>/Delay1' */
  real_T Switch17;                     /* '<S246>/Switch17' */
  real_T Switch8;                      /* '<S246>/Switch8' */
  real_T Switch4;                      /* '<S246>/Switch4' */
  real_T Switch3;                      /* '<S246>/Switch3' */
  real_T Switch6;                      /* '<S246>/Switch6' */
  real_T Switch5;                      /* '<S246>/Switch5' */
  real_T Switch10;                     /* '<S246>/Switch10' */
  real_T Switch9;                      /* '<S246>/Switch9' */
  real_T Switch7;                      /* '<S246>/Switch7' */
  real_T Switch2_l;                    /* '<S246>/Switch2' */
  real_T Switch19;                     /* '<S246>/Switch19' */
  ...
  real32_T Abs;                        /* '<S247>/Abs' */
  real32_T Sum1;                       /* '<S8>/Sum1' */
  real32_T UnitDelay;                  /* '<S240>/Unit Delay' */
  real32_T Sum2;                       /* '<S249>/Sum2' */
  real32_T Product1_h;                 /* '<S249>/Product1' */
  ...
  real32_T Sum2_j;                     /* '<S250>/Sum2' */
  real32_T Product1_n;                 /* '<S250>/Product1' */
  real32_T Sum_i;                      /* '<S241>/Sum' */
  real32_T Product_a;                  /* '<S241>/Product' */
  real32_T Sum1_o;                     /* '<S241>/Sum1' */
  real32_T Saturation_k;               /* '<S241>/Saturation' */
  real32_T Switch15;                   /* '<S8>/Switch15' */
  real32_T Delay5;                     /* '<S246>/Delay5' */
  real32_T Switch1_o;                  /* '<S246>/Switch1' */
  real32_T Gain4;                      /* '<S246>/Gain4' */
  real32_T Sum5;                       /* '<S246>/Sum5' */
  real32_T Gain3;                      /* '<S246>/Gain3' */
  real32_T Sum4;                       /* '<S246>/Sum4' */
  real32_T Delay1_b;                   /* '<S246>/Delay1' */
  real32_T Sum3;                       /* '<S246>/Sum3' */
  real32_T Gain_g;                     /* '<S246>/Gain' */
  real32_T Switch18;                   /* '<S246>/Switch18' */
  real32_T Switch7_d;                  /* '<S8>/Switch7' */
  real32_T Product4;                   /* '<S8>/Product4' */
  real32_T Subtract;                   /* '<S8>/Subtract' */
  real32_T Delay5_i;                   /* '<S245>/Delay5' */
  ...
  real32_T Switch17_e;                 /* '<S8>/Switch17' */
  real32_T Sum2_b;                     /* '<S246>/Sum2' */
  real32_T Gain2;                      /* '<S246>/Gain2' */
  real32_T Switch14;                   /* '<S246>/Switch14' */
  real32_T Switch13_o;                 /* '<S246>/Switch13' */
  ...
  real32_T Subtract1_p;                /* '<S8>/Subtract1' */
  real32_T Switch5_h;                  /* '<S8>/Switch5' */
  real32_T Switch4_a;                  /* '<S8>/Switch4' */
  real32_T Switch9_e;                  /* '<S8>/Switch9' */
  real32_T DataTypeConversion1_e;      /* '<S8>/Data Type Conversion1' */
  real32_T Product1_c;                 /* '<S8>/Product1' */
  real32_T Switch16;                   /* '<S8>/Switch16' */
  real32_T Sum1_pd;                    /* '<S246>/Sum1' */
  real32_T Gain1_h;                    /* '<S246>/Gain1' */
  real32_T Switch12;                   /* '<S246>/Switch12' */
  real32_T Switch11_i;                 /* '<S246>/Switch11' */
  real32_T Switch21;                   /* '<S246>/Switch21' */
  real32_T Switch20;                   /* '<S246>/Switch20' */
  ...
  real32_T Product5_p;                 /* '<S232>/Product5' */
  ...
  real32_T Product4_c;                 /* '<S16>/Product4' */
  ...
  real32_T Switch18_k;                 /* '<S8>/Switch18' */
  real32_T Sum6;                       /* '<S246>/Sum6' */
  real32_T Gain5;                      /* '<S246>/Gain5' */
  real32_T Switch16_c;                 /* '<S246>/Switch16' */
  real32_T Switch15_d;                 /* '<S246>/Switch15' */
  ...
  real32_T Switch2_l4;                 /* '<S89>/Switch2' */
  ...
  real32_T Delay1_e;                   /* '<S248>/Delay1' */
  real32_T Delay2_f;                   /* '<S248>/Delay2' */
  real32_T Delay3;                     /* '<S248>/Delay3' */
  real32_T Delay4;                     /* '<S248>/Delay4' */
  real32_T PO_A0_Hold;                 /* '<S248>/MATLAB Function' */
  real32_T PO_A1_Hold;                 /* '<S248>/MATLAB Function' */
  real32_T PO_A2_Hold;                 /* '<S248>/MATLAB Function' */
  real32_T PO_A3_Hold;                 /* '<S248>/MATLAB Function' */
  real32_T IntEvaSta;                  /* '<S242>/IntelligentEvasionSM' */
  ...
  real32_T Delay1_el;                  /* '<S112>/Delay1' */
  real32_T Switch2_a;                  /* '<S112>/Switch2' */
  ...
  uint8_T DataTypeConversion2_k4;      /* '<S247>/Data Type Conversion2' */
  uint8_T DataTypeConversion4_g;       /* '<S247>/Data Type Conversion4' */
  uint8_T DataTypeConversion_b;        /* '<S247>/Data Type Conversion' */
  uint8_T DataTypeConversion1_a3;      /* '<S247>/Data Type Conversion1' */
  uint8_T Delay_m5;                    /* '<S8>/Delay' */
  uint8_T Switch19_of;                 /* '<S242>/Switch19' */
  ...
  uint8_T Gain2_l;                     /* '<S8>/Gain2' */
  boolean_T DataTypeConversion3_ey;    /* '<S247>/Data Type Conversion3' */
  boolean_T RelationalOperator2;       /* '<S247>/Relational Operator2' */
  boolean_T RelationalOperator4;       /* '<S247>/Relational Operator4' */
  boolean_T RelationalOperator5;       /* '<S247>/Relational Operator5' */
  boolean_T RelationalOperator6;       /* '<S247>/Relational Operator6' */
  boolean_T LogicalOperator1;          /* '<S247>/Logical Operator1' */
  boolean_T RelationalOperator3;       /* '<S247>/Relational Operator3' */
  boolean_T RelationalOperator1;       /* '<S247>/Relational Operator1' */
  boolean_T LogicalOperator;           /* '<S247>/Logical Operator' */
  boolean_T Switch_l;                  /* '<S247>/Switch' */
  boolean_T Switch1_i5;                /* '<S247>/Switch1' */
  boolean_T RelationalOperator2_f;     /* '<S8>/Relational Operator2' */
  boolean_T RelationalOperator1_i;     /* '<S8>/Relational Operator1' */
  boolean_T RelationalOperator27;      /* '<S244>/Relational Operator27' */
  boolean_T RelationalOperator;        /* '<S237>/Relational Operator' */
  boolean_T RelationalOperator3_m;     /* '<S237>/Relational Operator3' */
  boolean_T LogicalOperator_o;         /* '<S237>/Logical Operator' */
  boolean_T RelationalOperator1_m;     /* '<S237>/Relational Operator1' */
  ...
  boolean_T RelationalOperator5_j;     /* '<S237>/Relational Operator5' */
  boolean_T LogicalOperator2;          /* '<S237>/Logical Operator2' */
  boolean_T RelationalOperator24;      /* '<S244>/Relational Operator24' */
  boolean_T LogicalOperator22;         /* '<S244>/Logical Operator22' */
  boolean_T RelationalOperator45;      /* '<S244>/Relational Operator45' */
  boolean_T RelationalOperator29;      /* '<S244>/Relational Operator29' */
  boolean_T RelationalOperator26;      /* '<S244>/Relational Operator26' */
  boolean_T LogicalOperator23;         /* '<S244>/Logical Operator23' */
  boolean_T RelationalOperator46;      /* '<S244>/Relational Operator46' */
  boolean_T RelationalOperator27_l;    /* '<S8>/Relational Operator27' */
  boolean_T RelationalOperator24_p;    /* '<S8>/Relational Operator24' */
  boolean_T LogicalOperator22_f;       /* '<S8>/Logical Operator22' */
  boolean_T RelationalOperator45_a;    /* '<S8>/Relational Operator45' */
  boolean_T LogicalOperator1_e;        /* '<S8>/Logical Operator1' */
  boolean_T LogicalOperator23_b;       /* '<S8>/Logical Operator23' */
  boolean_T RelationalOperator1_mz;    /* '<S246>/Relational Operator1' */
  boolean_T RelationalOperator20;      /* '<S246>/Relational Operator20' */
  boolean_T RelationalOperator4_i;     /* '<S246>/Relational Operator4' */
  boolean_T RelationalOperator2_b;     /* '<S246>/Relational Operator2' */
  boolean_T RelationalOperator6_h;     /* '<S246>/Relational Operator6' */
  boolean_T RelationalOperator5_jg;    /* '<S246>/Relational Operator5' */
  boolean_T RelationalOperator3_c;     /* '<S246>/Relational Operator3' */
  boolean_T RelationalOperator_p;      /* '<S152>/Relational Operator' */
  boolean_T RelationalOperator25;      /* '<S244>/Relational Operator25' */
  boolean_T RelationalOperator39;      /* '<S244>/Relational Operator39' */
  boolean_T RelationalOperator42;      /* '<S244>/Relational Operator42' */
  boolean_T RelationalOperator41;      /* '<S244>/Relational Operator41' */
  boolean_T LogicalOperator24;         /* '<S244>/Logical Operator24' */
  boolean_T LogicalOperator15;         /* '<S244>/Logical Operator15' */
  boolean_T RelationalOperator20_g;    /* '<S245>/Relational Operator20' */
  boolean_T LogicalOperator27;         /* '<S245>/Logical Operator27' */
  boolean_T RelationalOperator28;      /* '<S244>/Relational Operator28' */
  boolean_T RelationalOperator40;      /* '<S244>/Relational Operator40' */
  boolean_T RelationalOperator44;      /* '<S244>/Relational Operator44' */
  boolean_T RelationalOperator43;      /* '<S244>/Relational Operator43' */
  boolean_T LogicalOperator31;         /* '<S244>/Logical Operator31' */
  boolean_T LogicalOperator16;         /* '<S244>/Logical Operator16' */
  boolean_T LogicalOperator28;         /* '<S245>/Logical Operator28' */
  ...
  boolean_T RelationalOperator7;       /* '<S238>/Relational Operator7' */
  boolean_T LogicalOperator3;          /* '<S238>/Logical Operator3' */
  boolean_T RelationalOperator10;      /* '<S238>/Relational Operator10' */
  boolean_T RelationalOperator8;       /* '<S238>/Relational Operator8' */
  ...
  boolean_T RelationalOperator7_j;     /* '<S246>/Relational Operator7' */
  boolean_T RelationalOperator8_a;     /* '<S246>/Relational Operator8' */
  boolean_T LogicalOperator_c3;        /* '<S161>/Logical Operator' */
  ...
  B_signal_sustain_LCK_T sf_signal_sustain_c;/* '<S254>/signal_sustain' */
  B_signal_sustain_LCK_T sf_signal_sustain_k;/* '<S253>/signal_sustain' */
  B_signal_sustain_LCK_T sf_signal_sustain_e;/* '<S243>/signal_sustain' */
  ...
  B_Sustain_wo_reset_LCK_j_T sf_Sustain_wo_reset_ce;/* '<S125>/Sustain_wo_reset' */
  ...
  B_Sustain_wo_reset_LCK_j_T sf_Sustain_wo_reset_o;/* '<S120>/Sustain_wo_reset' */
...
typedef struct {
  ...
  real_T Delay1_DSTATE_c;              /* '<S244>/Delay1' */
  ...
  real_T Subtract2_DWORK1;             /* '<S6>/Subtract2' */
  ...
  real32_T Delay5_DSTATE;              /* '<S246>/Delay5' */
  real32_T Delay1_DSTATE_i;            /* '<S246>/Delay1' */
  real32_T Delay5_DSTATE_n;            /* '<S245>/Delay5' */
  ...
  real32_T Delay1_DSTATE_p;            /* '<S248>/Delay1' */
  real32_T Delay2_DSTATE_b;            /* '<S248>/Delay2' */
  real32_T Delay3_DSTATE;              /* '<S248>/Delay3' */
  real32_T Delay4_DSTATE;              /* '<S248>/Delay4' */
  ...
  uint8_T Delay_DSTATE_f;              /* '<S8>/Delay' */
  ...
  uint8_T is_active_c10_LCK;           /* '<S242>/IntelligentEvasionSM' */
  uint8_T is_c10_LCK;                  /* '<S242>/IntelligentEvasionSM' */
  ...
  DW_signal_sustain_LCK_T sf_signal_sustain_c;/* '<S254>/signal_sustain' */
  DW_signal_sustain_LCK_T sf_signal_sustain_k;/* '<S253>/signal_sustain' */
  DW_signal_sustain_LCK_T sf_signal_sustain_e;/* '<S243>/signal_sustain' */
  ...
  DW_Sustain_wo_reset_LCK_p_T sf_Sustain_wo_reset_ce;/* '<S125>/Sustain_wo_reset' */
  ...
  DW_Sustain_wo_reset_LCK_p_T sf_Sustain_wo_reset_o;/* '<S120>/Sustain_wo_reset' */
...
struct P_LCK_T_ {
  ...
  real_T Constant37_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant37'
                                        */
  real_T Constant1_Value_f;            /* Expression: 4
                                        * Referenced by: '<S237>/Constant1'
                                        */
  real_T Constant3_Value_k;            /* Expression: 3
  ...
  real_T Constant34_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant34'
                                        */
  real_T Constant53_Value;             /* Expression: 2000
                                        * Referenced by: '<S244>/Constant53'
                                        */
  real_T Constant56_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant56'
                                        */
  real_T Delay1_InitialCondition_c;    /* Expression: 0
                                        * Referenced by: '<S244>/Delay1'
                                        */
  real_T Constant39_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant39'
                                        */
  real_T Constant36_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant36'
                                        */
  real_T Constant54_Value;             /* Expression: 2000
                                        * Referenced by: '<S244>/Constant54'
                                        */
  real_T Constant57_Value;             /* Expression: 3
                                        * Referenced by: '<S244>/Constant57'
                                        */
  real_T Constant37_Value_g;           /* Expression: 3
                                        * Referenced by: '<S8>/Constant37'
                                        */
  real_T Constant34_Value_b;           /* Expression: 0
                                        * Referenced by: '<S8>/Constant34'
                                        */
  real_T Constant53_Value_f;           /* Expression: 200
                                        * Referenced by: '<S8>/Constant53'
                                        */
  real_T Constant56_Value_a;           /* Expression: 3
                                        * Referenced by: '<S8>/Constant56'
                                        */
  ...
  real_T Constant29_Value;             /* Expression: 1
                                        * Referenced by: '<S246>/Constant29'
                                        */
  real_T Constant9_Value;              /* Expression: 1
                                        * Referenced by: '<S246>/Constant9'
                                        */
  ...
  real_T Gain_Gain;                    /* Expression: 0.5
                                        ...
                                        */
  real_T Constant19_Value_i;           /* Expression: 0
  ...
  real_T Constant2_Value_az;           /* Expression: 1
                                        ...
                                        */
  real_T Constant3_Value_ko;           /* Expression: 2
  ...
  real_T Constant12_Value_e;           /* Expression: 1
                                        * Referenced by: '<S246>/Constant12'
                                        */
  real_T Constant11_Value_b;           /* Expression: 2
                                        * Referenced by: '<S246>/Constant11'
                                        */
  ...
  real_T Constant17_Value_h;           /* Expression: 1
                                        ...
                                        */
  real_T Constant19_Value_k;           /* Expression: 2
  ...
  real32_T Switch15_Threshold;         /* Computed Parameter: Switch15_Threshold
                                        * Referenced by: '<S8>/Switch15'
                                        */
  real32_T Delay5_InitialCondition;    /* Computed Parameter: Delay5_InitialCondition
                                        * Referenced by: '<S246>/Delay5'
                                        */
  real32_T Gain4_Gain;                 /* Computed Parameter: Gain4_Gain
                                        * Referenced by: '<S246>/Gain4'
                                        */
  real32_T Gain3_Gain;                 /* Computed Parameter: Gain3_Gain
                                        * Referenced by: '<S246>/Gain3'
                                        */
  ...
  real32_T Gain_Gain_pu;               /* Computed Parameter: Gain_Gain_pu
                                        ...
                                        */
  real32_T EvaCoff_Value;              /* Computed Parameter: EvaCoff_Value
                                        * Referenced by: '<S8>/EvaCoff'
                                        */
  ...
  real32_T Delay5_InitialCondition_b;  /* Computed Parameter: Delay5_InitialCondition_b
                                        * Referenced by: '<S245>/Delay5'
                                        */
  real32_T Switch17_Threshold;         /* Computed Parameter: Switch17_Threshold
                                        * Referenced by: '<S8>/Switch17'
                                        */
  ...
  real32_T Switch8_Threshold;          /* Computed Parameter: Switch8_Threshold
                                        ...
                                        */
  real32_T Switch19_Threshold;         /* Computed Parameter: Switch19_Threshold
                                        * Referenced by: '<S242>/Switch19'
                                        */
  real32_T EvaCoff1_Value;             /* Computed Parameter: EvaCoff1_Value
                                        * Referenced by: '<S8>/EvaCoff1'
                                        */
  real32_T Switch16_Threshold;         /* Computed Parameter: Switch16_Threshold
                                        * Referenced by: '<S8>/Switch16'
                                        */
  ...
  real32_T UnitDelay_InitialCondition_n;/* Computed Parameter: UnitDelay_InitialCondition_n
                                         ...
                                         */
  real32_T Switch18_Threshold;         /* Computed Parameter: Switch18_Threshold
                                        * Referenced by: '<S8>/Switch18'
                                        */
  real32_T Gain5_Gain;                 /* Computed Parameter: Gain5_Gain
                                        * Referenced by: '<S246>/Gain5'
                                        */
  ...
  real32_T Relay1_YOff;                /* Computed Parameter: Relay1_YOff
                                        * Referenced by: '<S73>/Relay1'
                                        */
  real32_T Switch15_Threshold_n;       /* Computed Parameter: Switch15_Threshold_n
  ...
  uint32_T Delay_DelayLength_e;        /* Computed Parameter: Delay_DelayLength_e
                                        * Referenced by: '<S168>/Delay'
                                        */
  uint32_T Delay_DelayLength_j0;       /* Computed Parameter: Delay_DelayLength_j0
                                        * Referenced by: '<S171>/Delay'
                                        */
  uint32_T Delay2_DelayLength_i;       /* Computed Parameter: Delay2_DelayLength_i
                                        * Referenced by: '<S171>/Delay2'
                                        */
  ...
  boolean_T Constant7_Value_e;         /* Computed Parameter: Constant7_Value_e
                                        * Referenced by: '<S247>/Constant7'
                                        */
  boolean_T DisableAVP_Value;          /* Computed Parameter: DisableAVP_Value
                                        * Referenced by: '<S247>/DisableAVP'
                                        */
  ...
  uint8_T Gain2_Gain_g;                /* Computed Parameter: Gain2_Gain_g
                                        ...
                                        */
  uint8_T Switch7_Threshold;           /* Computed Parameter: Switch7_Threshold
                                        * Referenced by: '<S8>/Switch7'
                                        */
  uint8_T Switch6_Threshold_j;         /* Computed Parameter: Switch6_Threshold_j
                                        * Referenced by: '<S8>/Switch6'
                                        */
  uint8_T Switch8_Threshold_l;         /* Computed Parameter: Switch8_Threshold_l
                                        * Referenced by: '<S8>/Switch8'
                                        */
  uint8_T Switch2_Threshold_h;         /* Computed Parameter: Switch2_Threshold_h
                                        * Referenced by: '<S8>/Switch2'
                                        */
  uint8_T Switch1_Threshold_d;         /* Computed Parameter: Switch1_Threshold_d
                                        * Referenced by: '<S8>/Switch1'
                                        */
  uint8_T Switch3_Threshold_g;         /* Computed Parameter: Switch3_Threshold_g
                                        * Referenced by: '<S8>/Switch3'
                                        */
  uint8_T Delay_InitialCondition_p;    /* Computed Parameter: Delay_InitialCondition_p
                                        * Referenced by: '<S8>/Delay'
                                        */
  uint8_T Constant8_Value_pt;          /* Computed Parameter: Constant8_Value_pt
                                        * Referenced by: '<S242>/Constant8'
                                        */
...
extern real32_T k_IntEvaSpdOn;         /* Variable: k_IntEvaSpdOn
                                        * Referenced by: '<S242>/IntelligentEvasionSM'
                                        */
...
extern void LCK(const LatCtrl_LCK_LanSigInputs_t *rtu_LCK_LanSigInputs, const
                ...
                *rtu_ZOP_LC_Command, const uint8_T *rtu_Lane_Bias_Flag, const
                uint8_T *rtu_Fus_Lane_Info_primaryObjTra, const real32_T
                ...
                *rtu_Ramp_Lane_Valid_Flag, const AVP_OUTPUT_ST *rtu_AVP_Info,
                real32_T *rty_LCK_Mode, real32_T *rty_SPP_Type, real32_T
                *rty_Lateral_HMI_LKS_Error, real32_T
                *rty_Lateral_HMI_LKS_Passive_Rea, real32_T
                *rty_Lateral_HMI_LKS_Status, real32_T
                *rty_Lateral_HMI_LC_pro_reason, real32_T
...
extern void LCK_Sustain_wo_reset(const boolean_T *rtu_input, real32_T
  ...
  localDW);
extern void LCK_Sustain_wo_reset_k_Init(B_Sustain_wo_reset_LCK_j_T *localB,
  DW_Sustain_wo_reset_LCK_p_T *localDW);
extern void LCK_Sustain_wo_reset_o(boolean_T rtu_input, real32_T
  rtu_sustain_time, B_Sustain_wo_reset_LCK_j_T *localB,
  DW_Sustain_wo_reset_LCK_p_T *localDW);
 ...
 * '<S242>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/IntEvaLogic'
 * '<S243>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Signal_Sustain_With_Clear'
 * '<S244>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem'
 * '<S245>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem1'
 * '<S246>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem2'
 * '<S247>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem3'
 * '<S248>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem4'
 * '<S249>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/First_Order_Lag_Filter_LIB/Filter_Gain'
 * '<S250>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/First_Order_Lag_Filter_LIB1/Filter_Gain'
 * '<S251>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/IntEvaLogic/IntelligentEvasionSM'
 * '<S252>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Signal_Sustain_With_Clear/signal_sustain'
 * '<S253>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem/Signal_Sustain_With_Clear'
 * '<S254>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem/Signal_Sustain_With_Clear1'
 * '<S255>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem/Signal_Sustain_With_Clear/signal_sustain'
 * '<S256>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem/Signal_Sustain_With_Clear1/signal_sustain'
 * '<S257>' : 'LCK/Lateral_Control_Module/Steer_Path_Process/Subsystem4/MATLAB Function'
 * '<S258>' : 'LCK/RTI Data/RTI Data Store'
 * '<S259>' : 'LCK/RTI Data/RTI Data Store/RTI Data Store'
 * '<S260>' : 'LCK/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 */
