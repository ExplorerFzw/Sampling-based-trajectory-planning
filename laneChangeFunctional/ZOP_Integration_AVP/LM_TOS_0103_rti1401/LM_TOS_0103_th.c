/************************ dSPACE target specific file *************************
   ...
   Include file .\LM_TOS_0103_rti1401\LM_TOS_0103_th.c :

   Task Configuration file for model : LM_TOS_0103

   RTI1401 7.12 (02-May-2019)/2.18
   03-Jan-2021 17:18:15
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\LM_TOS_0103_rti1401\LM_TOS_0103_th.c is for ST).
# endif
