 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Nov 21 14:10:00 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME CheckSum_0x244
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       u8_crc8
...
extern void CheckSum_0x244_Outputs_wrapper(const uint8_T *data,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *length = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    uint8_T *u8_crc8 = (uint8_T *) ssGetOutputPortRealSignal(S, 0);

    CheckSum_0x244_Outputs_wrapper(data, length, u8_crc8);
