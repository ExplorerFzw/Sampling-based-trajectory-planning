...
COMPUTER                       = PCWIN64
MODEL                          = fusionAlg
MODULES                        = fusionAlg_data.c fusionAlg_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
S_FUNCTIONS                    = sync.cpp funsionAlg_sfun_wrapper.c sensor_adapter.cpp fusion_process.cpp datastruct_fusion_internal_state.cpp coordinate_align.cpp double_bounce_remover.cpp signal_preprocess.cpp cluster_update.cpp fusion_predict.cpp radar_track_predict.cpp association.cpp cluster_manager.cpp group.cpp splitter.cpp fusion_track_manager.cpp fusion_update.cpp track_manager.cpp post_fusion_process.cpp output_adapter.cpp
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
