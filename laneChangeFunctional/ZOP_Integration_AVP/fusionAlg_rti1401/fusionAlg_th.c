/************************ dSPACE target specific file *************************
   ...
   Include file .\fusionAlg_rti1401\fusionAlg_th.c :

   Task Configuration file for model : fusionAlg

   RTI1401 7.12 (02-May-2019)/2.18
   30-Nov-2020 14:31:23
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\fusionAlg_rti1401\fusionAlg_th.c is for ST).
# endif
