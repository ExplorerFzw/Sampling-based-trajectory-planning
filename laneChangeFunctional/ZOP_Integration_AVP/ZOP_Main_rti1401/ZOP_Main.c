...
B_ZOP_Main_T ZOP_Main_B;

/* Block states (default storage) */
DW_ZOP_Main_T ZOP_Main_DW;

/* External inputs (root inport signals with default storage) */
ExtU_ZOP_Main_T ZOP_Main_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_ZOP_Main_T ZOP_Main_Y;

/* Real-time model */
RT_MODEL_ZOP_Main_T ZOP_Main_M_;
RT_MODEL_ZOP_Main_T *const ZOP_Main_M = &ZOP_Main_M_;
      ...
      if (FusionObj_objects[j].obj_property.id == ids[i]) {
        if (FusionObj_objects[j].obj_information.valid != 1) {
          ...
          if (Objects_in[i].x >= 0.0F) {
            ...
            if ((ZOP_Main_P.Constant9_Value_i < ZOP_Main_B.LC_Time_n) || rtIsNaN
                (ZOP_Main_B.LC_Time_n)) {
              ZOP_Main_B.MinMax = ZOP_Main_P.Constant9_Value_i;
            } else {
            ...
            ZOP_Main_B.Gain3 = ZOP_Main_P.Gain3_Gain_o * ZOP_Main_B.LC_Time_n;
            ZOP_Main_B.Add6 = ZOP_Main_B.Gain3 + ZOP_Main_P.Constant10_Value_e;
            ...
            if (ZOP_Main_B.LogicalOperator6) {
              ZOP_Main_B.Switch3_b = ZOP_Main_P.C_Value_d;
            } else {
              ZOP_Main_B.Switch3_b = ZOP_Main_B.Object_k.id;
            }

            if (ZOP_Main_B.Switch3_b > ZOP_Main_P.Switch1_Threshold_o) {
              ZOP_Main_B.Switch1_k = ZOP_Main_B.Object_k.x;
            } else {
              ZOP_Main_B.Switch1_k = ZOP_Main_P.Constant1_Value_e;
            }

            ZOP_Main_B.Saturation = ZOP_Main_B.VehStatus_e.vRef;
            if (ZOP_Main_B.Saturation > ZOP_Main_P.Saturation_UpperSat_n) {
              ZOP_Main_B.Saturation = ZOP_Main_P.Saturation_UpperSat_n;
            } else {
              if (ZOP_Main_B.Saturation < ZOP_Main_P.Saturation_LowerSat_i) {
                ZOP_Main_B.Saturation = ZOP_Main_P.Saturation_LowerSat_i;
              }
            }

            ZOP_Main_B.Divide = ZOP_Main_B.Switch1_k / ZOP_Main_B.Saturation *
              ZOP_Main_P.Constant7_Value_h;
            ZOP_Main_B.RelationalOperator3_n = (ZOP_Main_B.Divide <
              ZOP_Main_P.CF1_Value);
            if (ZOP_Main_B.Switch3_b > ZOP_Main_P.Switch2_Threshold_a) {
              ZOP_Main_B.Switch2_h = ZOP_Main_B.Object_k.vx;
            } else {
              ZOP_Main_B.Switch2_h = ZOP_Main_P.Constant2_Value_a;
            }

            ZOP_Main_B.Gain_c = ZOP_Main_P.Gain_Gain_f * ZOP_Main_B.LC_Time_n;
            ZOP_Main_B.Product = ZOP_Main_B.Switch2_h * ZOP_Main_B.Gain_c;
            if (ZOP_Main_B.Switch3_b > ZOP_Main_P.Switch4_Threshold_f) {
              ZOP_Main_B.Switch4_n = ZOP_Main_B.Object_k.ax;
            } else {
              ZOP_Main_B.Switch4_n = ZOP_Main_P.Constant36_Value_j;
            }

            ZOP_Main_B.Gain1 = ZOP_Main_P.Gain1_Gain_h * ZOP_Main_B.Switch4_n;
            ...
            if (ZOP_Main_B.Saturation1 > ZOP_Main_P.Saturation1_UpperSat_o) {
              ZOP_Main_B.Saturation1 = ZOP_Main_P.Saturation1_UpperSat_o;
            } else {
              if (ZOP_Main_B.Saturation1 < ZOP_Main_P.Saturation1_LowerSat_j) {
                ZOP_Main_B.Saturation1 = ZOP_Main_P.Saturation1_LowerSat_j;
              }
            }

            ZOP_Main_B.Divide1 = ZOP_Main_P.Constant7_Value_h * ZOP_Main_B.Add3 /
              ZOP_Main_B.Saturation1;
            ZOP_Main_B.RelationalOperator4_f = (ZOP_Main_P.CF2_Value >
              ZOP_Main_B.Divide1);
            ZOP_Main_B.LogicalOperator2 = (ZOP_Main_B.RelationalOperator3_n ||
              ZOP_Main_B.RelationalOperator4_f);
            ZOP_Main_B.RelationalOperator9 = (ZOP_Main_B.Divide <
              ZOP_Main_P.CF3_Value);
            ZOP_Main_B.RelationalOperator10 = (ZOP_Main_P.CF4_Value >
              ZOP_Main_B.Divide1);
            ...
            if (ZOP_Main_B.UnitDelay1_f) {
              ZOP_Main_B.Switch7_k = ZOP_Main_B.LogicalOperator2;
            } else {
            ...
            if ((ZOP_Main_P.Constant9_Value < ZOP_Main_B.LC_Time) || rtIsNaN
                (ZOP_Main_B.LC_Time)) {
              ZOP_Main_B.MinMax_n = ZOP_Main_P.Constant9_Value;
            } else {
            ...
            ZOP_Main_B.Gain3_o = ZOP_Main_P.Gain3_Gain * ZOP_Main_B.LC_Time;
            ZOP_Main_B.Add6_c = ZOP_Main_B.Gain3_o + ZOP_Main_P.Constant10_Value;
            ...
            if (ZOP_Main_B.LogicalOperator6_o) {
              ZOP_Main_B.Switch3_j = ZOP_Main_P.C_Value;
            } else {
              ZOP_Main_B.Switch3_j = ZOP_Main_B.Object.id;
            }

            if (ZOP_Main_B.Switch3_j > ZOP_Main_P.Switch1_Threshold) {
              ZOP_Main_B.Switch1_ko = ZOP_Main_B.Abs2;
            } else {
              ZOP_Main_B.Switch1_ko = ZOP_Main_P.Constant1_Value;
            }

            ZOP_Main_B.Saturation_e = ZOP_Main_B.VehStatus.vRef;
            if (ZOP_Main_B.Saturation_e > ZOP_Main_P.Saturation_UpperSat) {
              ZOP_Main_B.Saturation_e = ZOP_Main_P.Saturation_UpperSat;
            } else {
              if (ZOP_Main_B.Saturation_e < ZOP_Main_P.Saturation_LowerSat) {
                ZOP_Main_B.Saturation_e = ZOP_Main_P.Saturation_LowerSat;
              }
            }

            ZOP_Main_B.Divide_j = ZOP_Main_B.Switch1_ko /
              ZOP_Main_B.Saturation_e * ZOP_Main_P.Constant7_Value;
            ZOP_Main_B.RelationalOperator3_d = (ZOP_Main_B.Divide_j <
              ZOP_Main_P.CK1_Value);
            ZOP_Main_B.Gain2 = ZOP_Main_P.Gain2_Gain * ZOP_Main_B.Object.vx;
            if (ZOP_Main_B.Switch3_j > ZOP_Main_P.Switch2_Threshold) {
              ZOP_Main_B.Switch2_b = ZOP_Main_B.Gain2;
            } else {
              ZOP_Main_B.Switch2_b = ZOP_Main_P.Constant2_Value;
            }

            ZOP_Main_B.Gain_j = ZOP_Main_P.Gain_Gain * ZOP_Main_B.LC_Time;
            ZOP_Main_B.Product_b = ZOP_Main_B.Switch2_b * ZOP_Main_B.Gain_j;
            ZOP_Main_B.Gain4 = ZOP_Main_P.Gain4_Gain * ZOP_Main_B.Object.ax;
            if (ZOP_Main_B.Switch3_j > ZOP_Main_P.Switch4_Threshold) {
              ZOP_Main_B.Switch4_h = ZOP_Main_B.Gain4;
            } else {
              ZOP_Main_B.Switch4_h = ZOP_Main_P.Constant36_Value;
            }

            ZOP_Main_B.Gain1_o = ZOP_Main_P.Gain1_Gain * ZOP_Main_B.Switch4_h;
            ...
            if (ZOP_Main_B.Saturation1_k > ZOP_Main_P.Saturation1_UpperSat) {
              ZOP_Main_B.Saturation1_k = ZOP_Main_P.Saturation1_UpperSat;
            } else {
              if (ZOP_Main_B.Saturation1_k < ZOP_Main_P.Saturation1_LowerSat) {
                ZOP_Main_B.Saturation1_k = ZOP_Main_P.Saturation1_LowerSat;
              }
            }

            ZOP_Main_B.Divide1_o = ZOP_Main_P.Constant7_Value *
              ZOP_Main_B.Add3_e / ZOP_Main_B.Saturation1_k;
            ZOP_Main_B.RelationalOperator4_l = (ZOP_Main_P.CK2_Value >
            ...
            ZOP_Main_B.RelationalOperator9_l = (ZOP_Main_B.Divide_j <
              ZOP_Main_P.CK3_Value);
            ZOP_Main_B.RelationalOperator10_a = (ZOP_Main_P.CK4_Value >
              ZOP_Main_B.Divide1_o);
            ...
            ZOP_Main_B.RelationalOperator11_p = (ZOP_Main_P.CK5_Value >
              ZOP_Main_B.Divide1_o);
            ZOP_Main_B.RelationalOperator12_n = (ZOP_Main_B.Divide_j <
              ZOP_Main_P.CK5_Value);
  ...
  ZOP_Var_ST *ZOPVars_in, int8_T *lc_cmd, int8_T *lc_pro, int8_T *ZOP_Finish)
{
  ...
  *lc_pro = 0;
  ...
  if (MapInfo_Dist2Dest > 3000.0F) {
    ...
    ZOPVars_in->LnHi = minval;
    if (MapInfo_Dist2Dest < ZOP_Main_P.k_ZOP_ALC_D10) {
      ZOPVars_in->LnHi = 1;
    }
  }
  ...
  ZOPVars_in->SpdTmp[1] = 27.7777786F;
  ZOPVars_in->SpdTmp[2] = 27.7777786F;
  if ((FObj_id > 0.5) && (FObj_x < ZOP_Main_P.k_ZOP_SpdCkDstThr)) {
  ...
  for (i = 0; i < 8; i++) {
    TgtObj_0 = TgtObj[i];
    if (TgtObj_0.dir_f > 0) {
      if ((TgtObj_0.dir < 0) && (TgtObj_0.x < ZOP_Main_P.k_ZOP_SpdCkDstThr)) {
        u0 = ZOPVars_in->SpdTmp[1];
  ...
  ZOPVars_in->Spd[0] = (1.0F - ZOP_Main_P.k_ZOP_ObjSpd_cf) * ZOPVars_in->Spd[0]
    + ZOPVars_in->SpdTmp[0] * ZOP_Main_P.k_ZOP_ObjSpd_cf;
  ZOPVars_in->Spd[1] = (1.0F - ZOP_Main_P.k_ZOP_ObjSpd_cf) * ZOPVars_in->Spd[1]
    + ZOPVars_in->SpdTmp[1] * ZOP_Main_P.k_ZOP_ObjSpd_cf;
  ZOPVars_in->Spd[2] = (1.0F - ZOP_Main_P.k_ZOP_ObjSpd_cf) * ZOPVars_in->Spd[2]
    + ZOPVars_in->SpdTmp[2] * ZOP_Main_P.k_ZOP_ObjSpd_cf;
  if ((ZOP_Main_P.k_ZOP_ALC_SpdEnable > 0.5) && (ZOPVars_in->LCDir == 0)) {
    if (ZOPVars_in->Spd[0] + ZOP_Main_P.k_ZOP_SpdLoThr < ZOPVars_in->Spd[1]) {
    ...
    if (ZOPVars_in->Spd[0] + ZOP_Main_P.k_ZOP_SpdLoThr < ZOPVars_in->Spd[2]) {
    ...
    if ((real_T)ZOPVars_in->SpdTimeCnt[0] > ZOP_Main_P.k_ZOP_SpdLoTimeThr) {
  ...
  if (ZOP_Main_P.k_ZOP_ALC_Ramp > 0.5F) {
    if ((MapInfo_MapFlag != ZOPVars_in->MapFlag) && ((MapInfo_MapFlag == 1) ||
         (MapInfo_MapFlag == 2))) {
  ...
  if (((ZOP_Main_P.k_ZOP_ALC_Ramp < 0.5F) || (ZOPVars_in->MapFlagDir == 0)) &&
  ...
  if (ZOPVars_in->LSafeRaw == 1) {
    ...
    minval = (int8_T)i;
    if (minval >= ZOP_Main_P.k_ZOP_ALC_SCnt) {
      minval = ZOP_Main_P.k_ZOP_ALC_SCnt;
    }
    ...
    minval = (int8_T)i;
    if (minval >= ZOP_Main_P.k_ZOP_ALC_SNCnt) {
      minval = ZOP_Main_P.k_ZOP_ALC_SNCnt;
    }
  ...
  if (ZOPVars_in->LCDir == -1) {
    if ((ZOPVars_in->LSafeCnt <= ZOP_Main_P.k_ZOP_ALC_SCnt_Thr) ||
    ...
    if ((ZOPVars_in->LCDir == 1) && ((ZOPVars_in->RSafeCnt <=
          ZOP_Main_P.k_ZOP_ALC_SCnt_Thr) || (ZOPVars_in->RSafeNCnt > 3) ||
         (ZOPVars_in->RSafeRaw != 1))) {
      ZOPVars_in->LCDir = 0;
      q0 = ZOPVars_in->LCNRes + 4U;
      if (q0 > 65535U) {
  ...
  if ((ZOPVars_in->LCDir == 1) || (ZOPVars_in->LCDir == -1)) {
    if ((real_T)ZOPVars_in->holdTimeCnt > ZOP_Main_P.k_ZOP_HoldCnt) {
  ...
  if ((MapInfo_MapFlag != 0) && (ZOP_Main_P.k_ZOP_MapFlag_Enable > 0.5F)) {
    ZOPVars_in->LCCmd = 0;
  ...
  if ((real_T)ZOPVars_in->lcProTimeCnt > ZOP_Main_P.k_ZOP_LCProCnt) {
    *lc_cmd = ZOPVars_in->LCCmd;
  }

  if (ZOP_Main_P.k_ZOP_ALC_Enable < 0.5F) {
    *lc_cmd = 0;
    *lc_pro = 0;
    ZOPVars_in->LCRes = 0U;
    ZOPVars_in->LCTip = 0U;
  ...
  TgtObj[8], const ZOP_Var_ST *ZOPVars_in, int8_T *LC_Quit, ZOP_Var_ST *ZOPVars)
{
  ...
  *ZOPVars = *ZOPVars_in;
  ...
  if (ZOPVars->LSafeRaw == 1) {
    ...
    varargin_1 = (int8_T)i;
    if (varargin_1 >= ZOP_Main_P.k_ZOP_ALC_SCnt_LC) {
      varargin_1 = ZOP_Main_P.k_ZOP_ALC_SCnt_LC;
    }
    ...
    varargin_1 = (int8_T)i;
    if (varargin_1 >= ZOP_Main_P.k_ZOP_ALC_SNCnt_LC) {
      varargin_1 = ZOP_Main_P.k_ZOP_ALC_SNCnt_LC;
    }
  ...
  if (LKS_Status_lc_fail != 0) {
    ...
    ZOPVars->LCResult = 1;
             ...
             ZOP_Main_P.k_ZOP_LCTimeMax) {
    ZOPVars->LCResult = -1;
  } else if (LCCmd == -1) {
    if ((ZOPVars->LSafeNCnt >= ZOP_Main_P.k_ZOP_ALC_SCnt_Thr_LC) &&
        (ZOPVars->LSafeCnt <= 5) && (ZOPVars->LSafeRaw == 0)) {
      ZOPVars->LCResult = -1;
      ZOPVars->LCFailTip = 1;
    }
  } else {
    if ((LCCmd == 1) && (ZOPVars->RSafeNCnt >= ZOP_Main_P.k_ZOP_ALC_SCnt_Thr_LC)
  ...
  *LC_Quit = (int8_T)(ZOPVars->LCResult != 0);
}

/* Model output function */
void ZOP_Main_output(void)
{
   ...
   */
  if (ZOP_Main_P.k_ZOP_VoiceAct_Enable > ZOP_Main_P.Switch4_Threshold_m) {
    ZOP_Main_B.Switch4 = ZOP_Main_P.ZOPACT3_Value;
  } else {
    ZOP_Main_B.Switch4 = ZOP_Main_P.ZOPACT1_Value;
  }
   ...
   */
  dist = floor(ZOP_Main_P.ZOPACT_Value);
   ...
   *  Inport: '<Root>/ZOP_HMI_Req'
   */
  ZOP_Main_B.RelationalOperator2 = (ZOP_Main_U.ZOP_HMI_Req.Function_Activation ==
  ...
  if (ZOP_Main_B.RelationalOperator2) {
    ...
    ZOP_Main_B.Switch2 = ZOP_Main_P.ZOPACT2_Value;
  }
   ...
   *  DataTypeConversion: '<Root>/Data Type Conversion21'
   *  Inport: '<Root>/SystemCmd_Input'
   */
  ZOP_Main_B.DataTypeConversion21 = (uint8_T)(dist < 0.0 ? (int32_T)(uint8_T)
    -(int8_T)(uint8_T)-dist : (int32_T)(uint8_T)dist);
  ZOP_Main_B.MinMax_p = ZOP_Main_U.SystemCmd_Input.SystemEnable;
   ...
   */
  if (ZOP_Main_P.k_ZOP_VoiceAct_Enable > ZOP_Main_P.Switch5_Threshold) {
    ZOP_Main_B.Switch5 = ZOP_Main_P.ZOPACT7_Value;
  } else {
    ZOP_Main_B.Switch5 = ZOP_Main_P.ZOPACT6_Value;
  }
   ...
   */
  dist = floor(ZOP_Main_P.ZOPNACT1_Value);
  if (rtIsNaN(dist) || rtIsInf(dist)) {
    dist = 0.0;
  } else {
    dist = fmod(dist, 256.0);
   ...
   *  Inport: '<Root>/ZOP_HMI_Req'
   */
  ZOP_Main_B.RelationalOperator3 = (ZOP_Main_U.ZOP_HMI_Req.Function_Activation ==
  ...
  if (ZOP_Main_B.RelationalOperator3) {
    ...
    ZOP_Main_B.Switch3 = ZOP_Main_P.ZOPACT4_Value;
  }
  ...
  ZOP_Main_B.DataTypeConversion22 = (uint8_T)(dist < 0.0 ? (int32_T)(uint8_T)
    -(int8_T)(uint8_T)-dist : (int32_T)(uint8_T)dist);
  ZOP_Main_B.MinMax1 = ZOP_Main_U.SystemCmd_Input.SystemCancel;
   ...
   *  Inport: '<Root>/SystemCmd_Input'
   */
  ZOP_Main_B.BusCreator5.SystemOn = ZOP_Main_U.SystemCmd_Input.SystemOn;

  /* Gain: '<Root>/Gain' incorporates:
   *  Constant: '<Root>/ZOPACT8'
   */
  ZOP_Main_B.Gain = ZOP_Main_P.Gain_Gain_l * ZOP_Main_P.ZOPACT8_Value;
   ...
   *  Inport: '<Root>/SpdLmt'
   */
  if (ZOP_Main_P.k_ZOP_SpdLmt_Enable > ZOP_Main_P.Switch7_Threshold) {
    ZOP_Main_B.Switch7 = ZOP_Main_U.SpdLmt;
  } else {
   ...
   *  Inport: '<Root>/MapInfo'
   */
  ZOP_Main_B.DataTypeConversion17 = ZOP_Main_U.MapInfo.Dist2StopLine;

  /* DataTypeConversion: '<Root>/Data Type Conversion15' incorporates:
   *  Constant: '<Root>/C_Tmp2'
   */
  ZOP_Main_B.DataTypeConversion15 = (real32_T)ZOP_Main_P.C_Tmp2_Value_h;
   ...
   */
  ZOP_Main_B.DataTypeConversion16 = (real32_T)ZOP_Main_P.C_Tmp1_Value_f;
   ...
   *  Inport: '<Root>/LightInfo'
   */
  ZOP_Main_B.BusCreator4.color = ZOP_Main_U.LightInfo.color;
  ZOP_Main_B.BusCreator4.time = ZOP_Main_U.LightInfo.time;

  /* DataTypeConversion: '<Root>/Data Type Conversion12' incorporates:
   *  Inport: '<Root>/LKS_Mode'
   */
  ZOP_Main_B.DataTypeConversion12 = ZOP_Main_U.LKS_Mode;
   ...
   *  Inport: '<Root>/LC_dx'
   */
  ZOP_Main_B.DataTypeConversion14 = ZOP_Main_U.LC_dx;

  /* RelationalOperator: '<Root>/Relational Operator' incorporates:
   *  Constant: '<Root>/MODE_ZOP_LC'
   */
  ZOP_Main_B.RelationalOperator = (ZOP_Main_B.UnitDelay3 ==
    ZOP_Main_P.MODE_ZOP_LC);

  /* DataTypeConversion: '<Root>/Data Type Conversion18' incorporates:
   *  Constant: '<Root>/LCDist'
   */
  ZOP_Main_B.DataTypeConversion18 = (real32_T)ZOP_Main_P.LCDist_Value;
  ...
  if (ZOP_Main_DW.i % 2 == 0) {
     ...
     *  Constant: '<S2>/C_Tmp1'
     */
    ZOP_Main_B.DataTypeConversion15_a = (real32_T)ZOP_Main_P.C_Tmp1_Value;

    /* DataTypeConversion: '<S2>/Data Type Conversion3' */
    ZOP_Main_B.dist = ZOP_Main_B.BusCreator4.dist;

    /* DataTypeConversion: '<S2>/Data Type Conversion2' incorporates:
     *  Inport: '<Root>/VehStatus_Input'
     */
    ZOP_Main_B.DataTypeConversion2 = ZOP_Main_U.VehStatus_Input.vRef;
    ...
    if (ZOP_Main_B.RelationalOperator1_h) {
      ...
      ZOP_Main_B.Switch1_a = ZOP_Main_P.C_Tmp3_Value;
    }
     ...
     */
    if (ZOP_Main_P.k_ZOP_V2X_Enable > ZOP_Main_P.Switch_Threshold) {
     ...
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.DataTypeConversion4 = ZOP_Main_U.ACC_PO.Valid;
  ...
  if (ZOP_Main_DW.i >= 10) {
    ...
    if (ZOP_Main_DW.is_active_c4_ZOP_Main == 0U) {
      ...
      ZOP_Main_B.LaneCurPost = ZOP_Main_U.MapInfo.LaneIndex;
    } else {
      switch (ZOP_Main_DW.is_c4_ZOP_Main) {
       case ZOP_Main_IN_CHANGING:
        if ((ZOP_Main_B.UnitDelay1 != ZOP_Main_U.MapInfo.LaneIndex) ||
            (ZOP_Main_B.UnitDelay5 != ZOP_Main_U.MapInfo.LaneNum) ||
            (ZOP_Main_B.UnitDelay3_h == ZOP_Main_P.MODE_ZOP_LC)) {
          ZOP_Main_DW.is_c4_ZOP_Main = ZOP_Main_IN_CHANGING;
          ZOP_Main_B.LaneStable = 0.0F;
          ZOP_Main_DW.changingCnt = 0;
        } else if (((real_T)ZOP_Main_DW.changingCnt * 0.1 >
                    ZOP_Main_P.k_ZOP_LS_ChangingTime) &&
                   (ZOP_Main_U.VehStatus_Input.vRef * (real32_T)
                    ZOP_Main_DW.changingCnt * 0.1 >
                    ZOP_Main_P.k_ZOP_LS_ChangingDist)) {
          ZOP_Main_DW.is_c4_ZOP_Main = ZOP_Main_IN_STABLE;
          ZOP_Main_B.LaneStable = (real32_T)(ZOP_Main_U.MapInfo.LaneIndex != 0);
          ZOP_Main_B.LaneCurPost = ZOP_Main_U.MapInfo.LaneIndex;
       ...
       default:
        if (!ZOP_Main_B.UnitDelay2_g) {
          ...
          ZOP_Main_B.LaneStable = 0.0F;
          ZOP_Main_B.LaneCurPost = ZOP_Main_U.MapInfo.LaneIndex;
        } else if ((ZOP_Main_B.UnitDelay5 != ZOP_Main_U.MapInfo.LaneNum) ||
                   (ZOP_Main_B.UnitDelay1 != ZOP_Main_U.MapInfo.LaneIndex) ||
                   (ZOP_Main_B.UnitDelay3_h == ZOP_Main_P.MODE_ZOP_LC)) {
          ZOP_Main_DW.is_c4_ZOP_Main = ZOP_Main_IN_CHANGING;
          ZOP_Main_B.LaneStable = 0.0F;
          ZOP_Main_DW.changingCnt = 0;
    ...
    /* Chart: '<S4>/TargetCheck' incorporates:
     *  Inport: '<Root>/FusionObj_Input'
     *  Inport: '<Root>/RoadModel_TS_Input'
     *  Inport: '<Root>/VehStatus_Input'
     */
    if (ZOP_Main_DW.is_active_c5_ZOP_Main == 0U) {
      ...
      /*   */
      ObjNum = ZOP_Main_GetTarget(ZOP_Main_U.VehStatus_Input,
        ZOP_Main_U.FusionObj_Input.objects,
        ZOP_Main_U.RoadModel_TS_Input.L_NEIGHBORLANE_TAROBJ_0_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.L_NEIGHBORLANE_TAROBJ_1_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.L_NEIGHBORLANE_TAROBJ_2_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.L_NEIGHBORLANE_TAROBJ_3_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.R_NEIGHBORLANE_TAROBJ_0_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.R_NEIGHBORLANE_TAROBJ_1_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.R_NEIGHBORLANE_TAROBJ_2_ST.ID_un8,
        ZOP_Main_U.RoadModel_TS_Input.R_NEIGHBORLANE_TAROBJ_3_ST.ID_un8, (real_T)
     ...
     *  Inport: '<Root>/MapInfo'
     */
    ZOP_Main_B.BusCreator1.LaneNum = ZOP_Main_U.MapInfo.LaneNum;
    ZOP_Main_B.BusCreator1.MapFlag = ZOP_Main_U.MapInfo.MapFlag;
    ZOP_Main_B.BusCreator1.TgtSpd = ZOP_Main_U.MapInfo.TgtSpd;
    ZOP_Main_B.BusCreator1.isInZopZone = ZOP_Main_U.MapInfo.isInZopZone;
    ZOP_Main_B.BusCreator1.LocIndex = ZOP_Main_U.MapInfo.LocIndex;
    ZOP_Main_B.BusCreator1.Dist2Dest = ZOP_Main_U.MapInfo.Dist2Dest;
    ZOP_Main_B.BusCreator1.Dist2Start = ZOP_Main_U.MapInfo.Dist2Start;
    ZOP_Main_B.BusCreator1.Dist2StopLine = ZOP_Main_U.MapInfo.Dist2StopLine;
    ZOP_Main_B.BusCreator1.Dist2Merge = ZOP_Main_U.MapInfo.Dist2Merge;
    ZOP_Main_B.BusCreator1.LocLat = ZOP_Main_U.MapInfo.LocLat;
    ZOP_Main_B.BusCreator1.LocLon = ZOP_Main_U.MapInfo.LocLon;
    ZOP_Main_B.BusCreator1.SpeedLimit[0] = ZOP_Main_U.MapInfo.SpeedLimit[0];
    ZOP_Main_B.BusCreator1.SpeedLimit[1] = ZOP_Main_U.MapInfo.SpeedLimit[1];
    ZOP_Main_B.BusCreator1.SpeedLimit[2] = ZOP_Main_U.MapInfo.SpeedLimit[2];

    /* DataTypeConversion: '<S4>/Data Type Conversion18' incorporates:
     *  Constant: '<S4>/C_Tmp7'
     */
    dist = floor(ZOP_Main_P.C_Tmp7_Value);
    if (rtIsNaN(dist) || rtIsInf(dist)) {
      dist = 0.0;
    } else {
      dist = fmod(dist, 256.0);
     ...
     *  Inport: '<Root>/ACC_PO'
     */
    if (ZOP_Main_U.ACC_PO.Valid) {
      ZOP_Main_B.Switch = ZOP_Main_P.C_Tmp2_Value_f;
    } else {
      ZOP_Main_B.Switch = ZOP_Main_P.C_Tmp3_Value_p;
    }
     ...
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.BusCreator3.x = ZOP_Main_U.ACC_PO.dx;

    /* DataTypeConversion: '<S4>/Data Type Conversion10' incorporates:
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.BusCreator3.y = ZOP_Main_U.ACC_PO.dy;

    /* DataTypeConversion: '<S4>/Data Type Conversion11' incorporates:
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.BusCreator3.vx = ZOP_Main_U.ACC_PO.vx;

    /* DataTypeConversion: '<S4>/Data Type Conversion13' incorporates:
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.BusCreator3.vy = ZOP_Main_U.ACC_PO.vy;

    /* DataTypeConversion: '<S4>/Data Type Conversion14' incorporates:
     *  Inport: '<Root>/ACC_PO'
     */
    ZOP_Main_B.BusCreator3.ax = ZOP_Main_U.ACC_PO.ax;

    /* DataTypeConversion: '<S4>/Data Type Conversion15' incorporates:
     *  Constant: '<S4>/C_Tmp4'
     */
    ZOP_Main_B.BusCreator3.ay = (real32_T)ZOP_Main_P.C_Tmp4_Value;

    /* DataTypeConversion: '<S4>/Data Type Conversion16' incorporates:
     *  Constant: '<S4>/C_Tmp5'
     */
    dist = floor(ZOP_Main_P.C_Tmp5_Value);
    if (rtIsNaN(dist) || rtIsInf(dist)) {
      dist = 0.0;
    } else {
      dist = fmod(dist, 256.0);
     ...
     *  Constant: '<S4>/C_Tmp6'
     */
    dist = floor(ZOP_Main_P.C_Tmp6_Value);
    if (rtIsNaN(dist) || rtIsInf(dist)) {
      dist = 0.0;
    } else {
      dist = fmod(dist, 256.0);
    ...
    /* Chart: '<S4>/ZOP_State_Machine' incorporates:
     *  Inport: '<Root>/ACC_Output'
     *  Inport: '<Root>/FusionLane_Input'
     *  Inport: '<Root>/VehStatus_Input'
     *  Outport: '<Root>/ZOP_Takeover'
     */
    if (ZOP_Main_DW.is_active_c2_ZOP_Main == 0U) {
      ZOP_Main_DW.is_active_c2_ZOP_Main = 1U;
      ZOP_Main_DW.is_c2_ZOP_Main = ZOP_Main_IN_OFF;
      tmp_0 = ZOP_Main_P.MODE_ZOP_OFF;
      if (tmp_0 > 127) {
        tmp_0 = 127U;
      }

      /* Outport: '<Root>/ZOP_Mode' */
      ZOP_Main_Y.ZOP_Mode = (int8_T)tmp_0;
    } else {
      switch (ZOP_Main_DW.is_c2_ZOP_Main) {
       case ZOP_Main_IN_ENABLE:
        if ((ZOP_Main_U.ACC_Output.error == 1) || (ZOP_Main_B.LKS_Output.error ==
             1)) {
          ZOP_Main_DW.is_ENABLE = ZOP_Main_IN_NO_ACTIVE_CHILD;
          ZOP_Main_DW.is_c2_ZOP_Main = ZOP_Main_IN_ERROR;
          tmp_0 = ZOP_Main_P.MODE_ZOP_ERROR;
          if (tmp_0 > 127) {
            tmp_0 = 127U;
          }
          ...
          tmp_0 = ZOP_Main_P.MODE_ZOP_READY;
          if (tmp_0 > 127) {
            tmp_0 = 127U;
          }
          ...
          /* Outport: '<Root>/ZOP_Takeover' */
          ZOP_Main_Y.ZOP_Takeover = 0;
        } else if (ZOP_Main_Y.ZOP_Takeover != 0) {
          ZOP_Main_DW.is_ENABLE = ZOP_Main_IN_NO_ACTIVE_CHILD;
          ZOP_Main_DW.is_c2_ZOP_Main = ZOP_Main_IN_FINISH;
          tmp_0 = ZOP_Main_P.MODE_ZOP_FINISH;
          if (tmp_0 > 127) {
            tmp_0 = 127U;
          }
          ...
          switch (ZOP_Main_DW.is_ENABLE) {
           case ZOP_Main_IN_HOLD:
            tmp_0 = ZOP_Main_P.MODE_ZOP_HOLD;
            if (tmp_0 > 127) {
              tmp_0 = 127U;
            }
            ...
            /* Outport: '<Root>/ZOP_Mode' */
            ZOP_Main_Y.ZOP_Mode = (int8_T)tmp_0;
            if ((ZOP_Main_U.ACC_Output.overide == 1) ||
                (ZOP_Main_B.LKS_Output.overide == 1)) {
              ZOP_Main_DW.is_ENABLE = ZOP_Main_IN_OVERIDE;
              tmp_0 = ZOP_Main_P.MODE_ZOP_OVERIDE;
              if (tmp_0 > 127) {
                tmp_0 = 127U;
              }
              ...
              dist = ZOP_Main_CheckZopPreCondition
                (ZOP_Main_B.BusCreator1.isInZopZone, ZOP_Main_U.ACC_Output.ready,
                 ZOP_Main_U.ACC_Output.active, ZOP_Main_B.LKS_Output.ready,
              ...
              ZOP_Main_CheckZopLCCondition(ZOP_Main_U.VehStatus_Input.vRef,
                ZOP_Main_U.FusionLane_Input.leftHostLane.type,
                ZOP_Main_U.FusionLane_Input.rightHostLane.type,
           ...
           default:
            ...
            /* Outport: '<Root>/ZOP_Mode' */
            ZOP_Main_Y.ZOP_Mode = (int8_T)tmp_0;
            if ((ZOP_Main_U.ACC_Output.overide == 0) &&
                (ZOP_Main_B.LKS_Output.overide == 0)) {
              ZOP_Main_DW.is_ENABLE = ZOP_Main_IN_HOLD;
              tmp_0 = ZOP_Main_P.MODE_ZOP_HOLD;
              if (tmp_0 > 127) {
                tmp_0 = 127U;
       ...
       case ZOP_Main_IN_ERROR:
        ...
        /* Outport: '<Root>/ZOP_Mode' */
        ZOP_Main_Y.ZOP_Mode = (int8_T)tmp_0;
        if ((ZOP_Main_U.ACC_Output.error == 0) && (ZOP_Main_B.LKS_Output.error ==
             0)) {
          ZOP_Main_DW.is_c2_ZOP_Main = ZOP_Main_IN_READY;
          tmp_0 = ZOP_Main_P.MODE_ZOP_READY;
          if (tmp_0 > 127) {
       ...
       case ZOP_Main_IN_FINISH:
        ...
        if (ZOP_Main_B.BusCreator5.SystemOn != 1) {
          ...
          tmp_0 = ZOP_Main_P.MODE_ZOP_PASSIVE;
          if (tmp_0 > 127) {
            tmp_0 = 127U;
          }
       ...
       default:
        ...
        if (ZOP_Main_B.BusCreator5.SystemOn != 1) {
          ...
          ZOP_Main_Y.ZOP_Mode = (int8_T)tmp_0;
          ZOP_Main_InitHoldState(&ZOP_Main_B.ZOP_Vars);
        } else if ((ZOP_Main_U.ACC_Output.error == 1) ||
                   (ZOP_Main_B.LKS_Output.error == 1)) {
          ZOP_Main_DW.is_c2_ZOP_Main = ZOP_Main_IN_ERROR;
          tmp_0 = ZOP_Main_P.MODE_ZOP_ERROR;
          if (tmp_0 > 127) {
            tmp_0 = 127U;
    ...
    if (ZOP_Main_B.RelationalOperator2_m) {
      ZOP_Main_B.Switch2_d = ZOP_Main_P.C_Tmp12_Value;
    } else {
      ZOP_Main_B.Switch2_d = ZOP_Main_P.C_Tmp8_Value;
    }
    ...
    if (ZOP_Main_B.RelationalOperator4_c) {
      ZOP_Main_B.Switch1 = ZOP_Main_P.C_Tmp10_Value;
    } else {
     ...
     *  Constant: '<S4>/C_Tmp1'
     */
    dist = floor(ZOP_Main_P.C_Tmp1_Value_j);
    if (rtIsNaN(dist) || rtIsInf(dist)) {
      dist = 0.0;
    } else {
      dist = fmod(dist, 256.0);
     ...
     *  Outport: '<Root>/ZOP2HMI'
     */
    ZOP_Main_Y.ZOP2HMI_g.LCDir = ZOP_Main_B.DataTypeConversion7_i;
    ZOP_Main_Y.ZOP2HMI_g.LCRes = ZOP_Main_B.DataTypeConversion6_pu;
    ZOP_Main_Y.ZOP2HMI_g.LCTip = ZOP_Main_B.DataTypeConversion5_o;
    ZOP_Main_Y.ZOP2HMI_g.LCFailTip = ZOP_Main_B.DataTypeConversion4_h;
    ZOP_Main_Y.ZOP2HMI_g.LCReqTip = ZOP_Main_B.DataTypeConversion12_o;
    ZOP_Main_Y.ZOP2HMI_g.LCProp = ZOP_Main_B.DataTypeConversion12_o;
    ZOP_Main_Y.ZOP2HMI_g.LCPropRes = ZOP_Main_B.DataTypeConversion12_o;

    /* Gain: '<S4>/Gain' */
    ZOP_Main_B.Gain_c0 = (int16_T)(ZOP_Main_P.Gain_Gain_k *
     ...
     *  Outport: '<Root>/ZOP_Mode'
     */
    ZOP_Main_B.RelationalOperator1_d = (ZOP_Main_P.MODE_ZOP_ACTIVE <=
      ZOP_Main_Y.ZOP_Mode);
     ...
     *  Outport: '<Root>/ZOP_Mode'
     */
    ZOP_Main_B.RelationalOperator_e = (ZOP_Main_Y.ZOP_Mode <=
      ZOP_Main_P.MODE_ZOP_FINISH);

    /* Outport: '<Root>/ZOP_Enable' incorporates:
     *  Logic: '<S4>/Logical Operator'
     */
    ZOP_Main_Y.ZOP_Enable = (ZOP_Main_B.RelationalOperator1_d &&
      ZOP_Main_B.RelationalOperator_e);

    /* Update for UnitDelay: '<S4>/Unit Delay2' incorporates:
     *  Outport: '<Root>/ZOP_Enable'
     */
    ZOP_Main_DW.UnitDelay2_DSTATE_n = ZOP_Main_Y.ZOP_Enable;

    /* Update for UnitDelay: '<S4>/Unit Delay1' incorporates:
     *  Inport: '<Root>/MapInfo'
     */
    ZOP_Main_DW.UnitDelay1_DSTATE = ZOP_Main_U.MapInfo.LaneIndex;

    /* Update for UnitDelay: '<S4>/Unit Delay3' incorporates:
     *  Outport: '<Root>/ZOP_Mode'
     */
    ZOP_Main_DW.UnitDelay3_DSTATE_c = ZOP_Main_Y.ZOP_Mode;

    /* Update for UnitDelay: '<S4>/Unit Delay5' incorporates:
     *  Inport: '<Root>/MapInfo'
     */
    ZOP_Main_DW.UnitDelay5_DSTATE = ZOP_Main_U.MapInfo.LaneNum;
   ...
   *  Outport: '<Root>/ZOP_Mode'
   */
  ZOP_Main_Y.ZOP2ACC_i.state = (uint8_T)ZOP_Main_Y.ZOP_Mode;

  /* DataTypeConversion: '<Root>/Data Type Conversion10' incorporates:
   *  Outport: '<Root>/ZOP_Enable'
   */
  ZOP_Main_Y.ZOP2ACC_i.activate_acc = ZOP_Main_Y.ZOP_Enable;

  /* DataTypeConversion: '<Root>/Data Type Conversion9' */
  ZOP_Main_Y.ZOP2ACC_i.spd_lmt = (real32_T)ZOP_Main_B.Switch7;

  /* DataTypeConversion: '<Root>/Data Type Conversion8' */
  ZOP_Main_Y.ZOP2ACC_i.light_des_spd = (real32_T)ZOP_Main_B.v_des;

  /* DataTypeConversion: '<Root>/Data Type Conversion7' */
  ZOP_Main_Y.ZOP2ACC_i.light_a_des = (real32_T)ZOP_Main_B.a_des;
  ...
  ZOP_Main_Y.ZOP2ACC_i.case_num = (int8_T)(tmp_1 < 0.0F ? (int32_T)(int8_T)
    -(int8_T)(uint8_T)-tmp_1 : (int32_T)(int8_T)(uint8_T)tmp_1);

  /* End of DataTypeConversion: '<Root>/Data Type Conversion6' */

  /* DataTypeConversion: '<Root>/Data Type Conversion5' */
  ZOP_Main_Y.ZOP2ACC_i.light_dist = ZOP_Main_B.BusCreator4.dist;

  /* DataTypeConversion: '<Root>/Data Type Conversion4' incorporates:
   *  Outport: '<Root>/ZOP_Mode'
   */
  ZOP_Main_Y.ZOP2LKS.state = (uint8_T)ZOP_Main_Y.ZOP_Mode;

  /* DataTypeConversion: '<Root>/Data Type Conversion3' incorporates:
   *  Outport: '<Root>/ZOP_Enable'
   */
  ZOP_Main_Y.ZOP2LKS.activate_lck = ZOP_Main_Y.ZOP_Enable;

  /* DataTypeConversion: '<Root>/Data Type Conversion2' */
  ZOP_Main_Y.ZOP2LKS.lc_cmd = (int8_T)(ZOP_Main_B.Gain_c0 >> 7);

  /* RelationalOperator: '<Root>/Relational Operator4' incorporates:
   *  Constant: '<Root>/MODE_ZOP_FINISH'
   *  Outport: '<Root>/ZOP_Mode'
   */
  ZOP_Main_B.RelationalOperator4 = (ZOP_Main_Y.ZOP_Mode ==
    ZOP_Main_P.MODE_ZOP_FINISH);
   ...
   */
  if (ZOP_Main_P.k_ZOP_VcTJA_Enable > ZOP_Main_P.Switch6_Threshold) {
    ZOP_Main_B.Switch6 = ZOP_Main_B.Switch2;
  } else {
    ZOP_Main_B.Switch6 = ZOP_Main_P.ZOPACT5_Value;
  }

  /* End of Switch: '<Root>/Switch6' */

  /* Logic: '<Root>/Logical Operator1' */
  ZOP_Main_B.LogicalOperator1 = (ZOP_Main_B.RelationalOperator5 ||
    (ZOP_Main_B.Switch6 != 0.0));

  /* DataTypeConversion: '<Root>/Data Type Conversion13' */
  ZOP_Main_Y.ZOP2TJA_j.activate_tja = ZOP_Main_B.LogicalOperator1;

  /* DataTypeConversion: '<Root>/Data Type Conversion1' incorporates:
   *  Outport: '<Root>/ZOP_Enable'
   */
  ZOP_Main_Y.ZOP2TJA_j.is_zop_active = ZOP_Main_Y.ZOP_Enable;
}

/* Model update function */
void ZOP_Main_update(void)
{
  /* Update for UnitDelay: '<Root>/Unit Delay3' incorporates:
   *  Outport: '<Root>/ZOP_Mode'
   */
  ZOP_Main_DW.UnitDelay3_DSTATE = ZOP_Main_Y.ZOP_Mode;
   ...
   */
  if (!(++ZOP_Main_M->Timing.clockTick0)) {
    ++ZOP_Main_M->Timing.clockTickH0;
  }

  ZOP_Main_M->Timing.taskTime0 = ZOP_Main_M->Timing.clockTick0 *
    ZOP_Main_M->Timing.stepSize0 + ZOP_Main_M->Timing.clockTickH0 *
    ZOP_Main_M->Timing.stepSize0 * 4294967296.0;
}

/* Model initialize function */
void ZOP_Main_initialize(void)
{
  /* Registration code */
  ...
  (void) memset((void *)ZOP_Main_M, 0,
                sizeof(RT_MODEL_ZOP_Main_T));
  ZOP_Main_M->Timing.stepSize0 = 0.01;
  ...
  (void) memset((void *)&ZOP_Main_DW, 0,
                sizeof(DW_ZOP_Main_T));

  /* external inputs */
  (void)memset(&ZOP_Main_U, 0, sizeof(ExtU_ZOP_Main_T));

  /* external outputs */
  (void) memset((void *)&ZOP_Main_Y, 0,
                sizeof(ExtY_ZOP_Main_T));
...

  {
    ...
    ZOP_Main_DW.UnitDelay3_DSTATE = ZOP_Main_P.UnitDelay3_InitialCondition_m;

    /* InitializeConditions for UnitDelay: '<Root>/Unit Delay2' */
    ZOP_Main_DW.UnitDelay2_DSTATE = ZOP_Main_P.UnitDelay2_InitialCondition_j;
    ZOP_Main_DW.i = 0;
    ...
    ZOP_Main_B.v_des = ZOP_Main_P.v_des_Y0;

    /* SystemInitialize for Outport: '<S2>/a_des' */
    ZOP_Main_B.a_des = ZOP_Main_P.a_des_Y0;

    /* SystemInitialize for Outport: '<S2>/case_num' */
    ZOP_Main_B.Switch_m = ZOP_Main_P.case_num_Y0;

    /* SystemInitialize for Chart: '<Root>/ZOP_OS' incorporates:
     *  SubSystem: '<Root>/ZOP_Main_OS'
     */
    /* InitializeConditions for UnitDelay: '<S4>/Unit Delay2' */
    ZOP_Main_DW.UnitDelay2_DSTATE_n = ZOP_Main_P.UnitDelay2_InitialCondition;

    /* InitializeConditions for UnitDelay: '<S4>/Unit Delay1' */
    ZOP_Main_DW.UnitDelay1_DSTATE = ZOP_Main_P.UnitDelay1_InitialCondition_b;

    /* InitializeConditions for UnitDelay: '<S4>/Unit Delay3' */
    ZOP_Main_DW.UnitDelay3_DSTATE_c = ZOP_Main_P.UnitDelay3_InitialCondition;

    /* InitializeConditions for UnitDelay: '<S4>/Unit Delay5' */
    ZOP_Main_DW.UnitDelay5_DSTATE = ZOP_Main_P.UnitDelay5_InitialCondition;

    /* InitializeConditions for UnitDelay: '<S4>/Unit Delay4' */
    ZOP_Main_DW.UnitDelay4_DSTATE_l = ZOP_Main_P.UnitDelay4_InitialCondition;
    ...
    ZOP_Main_DW.UnitDelay1_DSTATE_o = ZOP_Main_P.UnitDelay1_InitialCondition;

    /* SystemInitialize for Outport: '<S16>/TargetExist' */
    ZOP_Main_B.LogicalOperator5_m = ZOP_Main_P.TargetExist_Y0;

    /* SystemInitialize for Outport: '<S16>/TargetExist2' */
    ZOP_Main_B.LogicalOperator4_j = ZOP_Main_P.TargetExist2_Y0;

    /* SystemInitialize for Chart: '<S4>/TargetCheck' incorporates:
     *  SubSystem: '<S13>/DEFAULT.CheckTargetF'
     */
    /* InitializeConditions for UnitDelay: '<S15>/Unit Delay1' */
    ZOP_Main_DW.UnitDelay1_DSTATE_g = ZOP_Main_P.UnitDelay1_InitialCondition_j;

    /* SystemInitialize for Outport: '<S15>/TargetExist' */
    ZOP_Main_B.LogicalOperator5 = ZOP_Main_P.TargetExist_Y0_m;

    /* SystemInitialize for Outport: '<S15>/TargetExist2' */
    ZOP_Main_B.LogicalOperator4 = ZOP_Main_P.TargetExist2_Y0_c;
    ...
    /* InitializeConditions for Outport: '<Root>/ZOP_Mode' incorporates:
     *  Chart: '<S4>/ZOP_State_Machine'
     */
    ZOP_Main_Y.ZOP_Mode = 0;

    /* InitializeConditions for Outport: '<Root>/ZOP_Takeover' incorporates:
     *  Chart: '<S4>/ZOP_State_Machine'
     */
    ZOP_Main_Y.ZOP_Takeover = 0;
    ...
    /* SystemInitialize for Outport: '<Root>/ZOP_Enable' incorporates:
     *  Outport: '<S4>/ZOP_Enable'
     */
    ZOP_Main_Y.ZOP_Enable = ZOP_Main_P.ZOP_Enable_Y0;

    /* SystemInitialize for Outport: '<S4>/LC_Cmd' */
    ZOP_Main_B.Gain_c0 = ZOP_Main_P.LC_Cmd_Y0;

    /* SystemInitialize for Outport: '<Root>/ZOP2HMI' incorporates:
     *  Outport: '<S4>/ZOP2HMI'
     */
    ZOP_Main_Y.ZOP2HMI_g = ZOP_Main_P.ZOP2HMI_Y0;

    /* SystemInitialize for Chart: '<Root>/ZOP_OS' incorporates:
     *  SubSystem: '<Root>/LKS_Mode_Conv'
     */
    /* InitializeConditions for UnitDelay: '<S1>/Unit Delay4' */
    ZOP_Main_DW.UnitDelay4_DSTATE = ZOP_Main_P.UnitDelay4_InitialCondition_m;

    /* SystemInitialize for Outport: '<S1>/Out1' */
    ZOP_Main_B.LKS_Output = ZOP_Main_P.Out1_Y0;
  }
}

/* Model terminate function */
void ZOP_Main_terminate(void)
{
