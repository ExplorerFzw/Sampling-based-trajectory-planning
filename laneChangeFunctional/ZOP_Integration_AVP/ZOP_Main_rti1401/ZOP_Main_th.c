/************************ dSPACE target specific file *************************
   ...
   Include file .\ZOP_Main_rti1401\ZOP_Main_th.c :

   Task Configuration file for model : ZOP_Main

   RTI1401 7.12 (02-May-2019)/2.18
   03-Feb-2021 13:27:16
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\ZOP_Main_rti1401\ZOP_Main_th.c is for ST).
# endif
