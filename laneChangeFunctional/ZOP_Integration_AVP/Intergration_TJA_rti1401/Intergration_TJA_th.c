/************************ dSPACE target specific file *************************
   ...
   Include file .\Intergration_TJA_rti1401\Intergration_TJA_th.c :

   Task Configuration file for model : Intergration_TJA

   RTI1401 7.12 (02-May-2019)/2.18
   30-Dec-2020 09:26:22
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Intergration_TJA_rti1401\Intergration_TJA_th.c is for ST).
# endif
...
int                  *pRti_TIMERA_Prio;
  ...
  /* --- Task  2 : CAN_TYPE1_INT_M3_C2 (HWINT CAN2) */
...
int                  *pRti_CAN2_Prio;
  ...
  /* --- Task  3 : _CAN_TYPE1_INT_M3_C2 (HWINT CAN1) */
...
int                  *pRti_CAN1_Prio;
  ...
  /* --- Task  4 : __CAN_TYPE1_INT_M3_C2 (HWINT CAN4) */
...
int                  *pRti_CAN4_Prio;
  ...
  /* --- Task  5 : ___CAN_TYPE1_INT_M3_C2 (HWINT CAN3) */
...
int                  *pRti_CAN3_Prio;
  ...
  /* --- Task  6 : CAN_TYPE1_INT_M3_C1 (HWINT CAN6) */
...
int                  *pRti_CAN6_Prio;
  ...
  /* --- Task  7 : _CAN_TYPE1_INT_M3_C1 (HWINT CAN5) */
...
int                  *pRti_CAN5_Prio;
  ...
  /* --- Task  8 : __CAN_TYPE1_INT_M3_C1 (HWINT CAN8) */
...
int                  *pRti_CAN8_Prio;
  ...
  /* --- Task  9 : ___CAN_TYPE1_INT_M3_C1 (HWINT CAN7) */
...
# endif
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN2_TTime         = &(pTask2->turnaround_time);
  pRti_CAN2_TState        = &(pTask2->state);
  pRti_CAN2_OType         = &(pTask2->ovc_type);
  pRti_CAN2_OMax          = &(pTask2->ovc_max);
  pRti_CAN2_ORpt          = &(pTask2->ovc_repeat);
  pRti_CAN2_OCnt          = &(pTask2->ovc_counter);
  pRti_CAN2_TCnt          = &(pTask2->tm_task_calls);
  pRti_CAN2_Prio          = &(pTask2->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN1_TTime         = &(pTask3->turnaround_time);
  pRti_CAN1_TState        = &(pTask3->state);
  pRti_CAN1_OType         = &(pTask3->ovc_type);
  pRti_CAN1_OMax          = &(pTask3->ovc_max);
  pRti_CAN1_ORpt          = &(pTask3->ovc_repeat);
  pRti_CAN1_OCnt          = &(pTask3->ovc_counter);
  pRti_CAN1_TCnt          = &(pTask3->tm_task_calls);
  pRti_CAN1_Prio          = &(pTask3->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN4_TTime         = &(pTask4->turnaround_time);
  pRti_CAN4_TState        = &(pTask4->state);
  pRti_CAN4_OType         = &(pTask4->ovc_type);
  pRti_CAN4_OMax          = &(pTask4->ovc_max);
  pRti_CAN4_ORpt          = &(pTask4->ovc_repeat);
  pRti_CAN4_OCnt          = &(pTask4->ovc_counter);
  pRti_CAN4_TCnt          = &(pTask4->tm_task_calls);
  pRti_CAN4_Prio          = &(pTask4->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN3_TTime         = &(pTask5->turnaround_time);
  pRti_CAN3_TState        = &(pTask5->state);
  pRti_CAN3_OType         = &(pTask5->ovc_type);
  pRti_CAN3_OMax          = &(pTask5->ovc_max);
  pRti_CAN3_ORpt          = &(pTask5->ovc_repeat);
  pRti_CAN3_OCnt          = &(pTask5->ovc_counter);
  pRti_CAN3_TCnt          = &(pTask5->tm_task_calls);
  pRti_CAN3_Prio          = &(pTask5->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN6_TTime         = &(pTask6->turnaround_time);
  pRti_CAN6_TState        = &(pTask6->state);
  pRti_CAN6_OType         = &(pTask6->ovc_type);
  pRti_CAN6_OMax          = &(pTask6->ovc_max);
  pRti_CAN6_ORpt          = &(pTask6->ovc_repeat);
  pRti_CAN6_OCnt          = &(pTask6->ovc_counter);
  pRti_CAN6_TCnt          = &(pTask6->tm_task_calls);
  pRti_CAN6_Prio          = &(pTask6->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN5_TTime         = &(pTask7->turnaround_time);
  pRti_CAN5_TState        = &(pTask7->state);
  pRti_CAN5_OType         = &(pTask7->ovc_type);
  pRti_CAN5_OMax          = &(pTask7->ovc_max);
  pRti_CAN5_ORpt          = &(pTask7->ovc_repeat);
  pRti_CAN5_OCnt          = &(pTask7->ovc_counter);
  pRti_CAN5_TCnt          = &(pTask7->tm_task_calls);
  pRti_CAN5_Prio          = &(pTask7->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN8_TTime         = &(pTask8->turnaround_time);
  pRti_CAN8_TState        = &(pTask8->state);
  pRti_CAN8_OType         = &(pTask8->ovc_type);
  pRti_CAN8_OMax          = &(pTask8->ovc_max);
  pRti_CAN8_ORpt          = &(pTask8->ovc_repeat);
  pRti_CAN8_OCnt          = &(pTask8->ovc_counter);
  pRti_CAN8_TCnt          = &(pTask8->tm_task_calls);
  pRti_CAN8_Prio          = &(pTask8->priority);
  ...
  /* ... Assign task information variables ................................. */
  pRti_CAN7_TTime         = &(pTask9->turnaround_time);
  pRti_CAN7_TState        = &(pTask9->state);
  pRti_CAN7_OType         = &(pTask9->ovc_type);
  pRti_CAN7_OMax          = &(pTask9->ovc_max);
  pRti_CAN7_ORpt          = &(pTask9->ovc_repeat);
  pRti_CAN7_OCnt          = &(pTask9->ovc_counter);
  pRti_CAN7_TCnt          = &(pTask9->tm_task_calls);
  pRti_CAN7_Prio          = &(pTask9->priority);
