...
MATLAB_ROOT_ALT                = D:\Program Files\MATLAB\R2018b
MATLAB_BIN_ALT                 = D:\Program Files\MATLAB\R2018b\bin
RELEASE_VERSION                = R2018b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = fusionAlg
MODULES                        = fusionAlg.c fusionAlg_trc_ptr.c
S_FUNCTIONS                    = funsionAlg_sfun_wrapper.c sensor_adapter.cpp fusion_process.cpp radar_track_predict.cpp datastruct_fusion_internal_state.cpp coordinate_align.cpp double_bounce_remover.cpp signal_preprocess.cpp cluster_update.cpp fusion_predict.cpp predict.cpp association.cpp group.cpp splitter.cpp fusion_track_manager.cpp fusion_update.cpp track_manager.cpp post_fusion_process.cpp output_adapter.cpp combine_all_radar.cpp
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = F:\DatabaseZO\08.Code\Model\ZOP_Integration
...
RTW_MODELLIB                   = fusionAlg_rtwlib.lib
RTW_MODELREF_LINK_LIBS         = 
RTW_MODELREF_TARGET_TYPE       = RTW
RTW_MODELREFS                  = 
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\slprj\rti1401\fusionAlg" \
