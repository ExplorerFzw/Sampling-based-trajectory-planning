...
COMPUTER                       = PCWIN64
MODEL                          = LM_TOS
MODULES                        = LM_TOS.c LM_TOS_trc_ptr.c
S_FUNCTIONS                    = TOSBase.cpp LM_TOS_MODULE_wrapper.c HMI.cpp Adapters.cpp LMMathLib.cpp LMBase.cpp LMTOSRunAlgo.cpp LMPp.cpp LMF.cpp TOSHWA.cpp TOSPp.cpp VehicleMovement.cpp VSL.cpp TOSNRA.cpp TOSTruckEvasion.cpp CoordinationTransformation.cpp LMCommonDefines.cpp Parameters.cpp DrivingManeuver.cpp
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
RTW_MODELLIB                   = LM_TOS_rtwlib.lib
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\slprj\rti1401\LM_TOS" \
