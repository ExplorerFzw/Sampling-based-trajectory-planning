...
COMPUTER                       = PCWIN64
MODEL                          = LM_TOS_1229
MODULES                        = LM_TOS_1229.c LM_TOS_1229_trc_ptr.c
S_FUNCTIONS                    = LM_TOS_MODULE_wrapper.c LM_TOS_RUN_ALGO.cpp HMI.cpp adapters.cpp TOS_HWA.cpp LM_BASE.cpp lm_math_lib.cpp LM_PP.cpp LMF.cpp TOS_BASE.cpp TOS_PP.cpp COORDINATETRANSFORMATION.cpp VSL.cpp TOS_NRA.cpp TOS_TRUCK_EVASION.cpp
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
TID01EQ                        = 0
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = F:\DatabaseZO\08.Code\Model\ZOP_Integration_20201230
...
RTW_MODELLIB                   = LM_TOS_1229_rtwlib.lib
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\slprj\rti1401\LM_TOS_1229" \
...
TMP_PATH_CC += "D:\00_Work\00_ZOP\00_ZOP_Demo_sim\LaneModel_20201229_CYX"
TMP_PATH_CC += "$(MATLAB_ROOT)\rtw\c\src"
