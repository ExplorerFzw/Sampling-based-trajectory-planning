/************************ dSPACE target specific file *************************
   ...
   Include file .\AccTarSel_rti1401\AccTarSel_th.c :

   Task Configuration file for model : AccTarSel

   RTI1401 7.12 (02-May-2019)/2.18
   02-Dec-2020 15:41:53
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\AccTarSel_rti1401\AccTarSel_th.c is for ST).
# endif
