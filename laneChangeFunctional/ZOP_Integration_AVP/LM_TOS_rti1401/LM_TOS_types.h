...
#ifndef RTW_HEADER_LM_TOS_types_h_
#define RTW_HEADER_LM_TOS_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_HWA_TARGETOBJECT_OUTPUT_ADAPTER_ST_
#define DEFINED_TYPEDEF_FOR_HWA_TARGETOBJECT_OUTPUT_ADAPTER_ST_

typedef struct {
  TARGETOBJECT_adp L_NEIGHBORLANE_TAROBJ_0_ST;
  TARGETOBJECT_adp L_NEIGHBORLANE_TAROBJ_1_ST;
  TARGETOBJECT_adp L_NEIGHBORLANE_TAROBJ_2_ST;
  TARGETOBJECT_adp L_NEIGHBORLANE_TAROBJ_3_ST;
  TARGETOBJECT_adp EGOLANE_TAROBJ_0_ST;
  TARGETOBJECT_adp EGOLANE_TAROBJ_1_ST;
  TARGETOBJECT_adp EGOLANE_TAROBJ_2_ST;
  TARGETOBJECT_adp EGOLANE_TAROBJ_3_ST;
  TARGETOBJECT_adp R_NEIGHBORLANE_TAROBJ_0_ST;
  TARGETOBJECT_adp R_NEIGHBORLANE_TAROBJ_1_ST;
  TARGETOBJECT_adp R_NEIGHBORLANE_TAROBJ_2_ST;
  TARGETOBJECT_adp R_NEIGHBORLANE_TAROBJ_3_ST;
} HWA_TARGETOBJECT_OUTPUT_ADAPTER_ST;
...
typedef struct P_LM_TOS_T_ P_LM_TOS_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_LM_TOS_T RT_MODEL_LM_TOS_T;

#endif                                 /* RTW_HEADER_LM_TOS_types_h_ */
