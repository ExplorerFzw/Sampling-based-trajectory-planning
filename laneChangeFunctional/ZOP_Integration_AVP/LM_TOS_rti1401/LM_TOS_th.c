/************************ dSPACE target specific file *************************
   ...
   Include file .\LM_TOS_rti1401\LM_TOS_th.c :

   Task Configuration file for model : LM_TOS

   RTI1401 7.12 (02-May-2019)/2.18
   20-Jan-2021 09:24:00
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\LM_TOS_rti1401\LM_TOS_th.c is for ST).
# endif
