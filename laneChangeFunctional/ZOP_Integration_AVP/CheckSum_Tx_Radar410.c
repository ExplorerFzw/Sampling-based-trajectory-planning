 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Dec 11 16:47:07 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME CheckSum_Tx_Radar410
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    CheckSum_Tx_Radar410_Outputs_wrapper(data, length, u8_crc8);
