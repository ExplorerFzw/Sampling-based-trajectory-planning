...
/*                                                                                                      */                 
/* $RCSFile: rticanmm_setup.c $ $Revision: 2.323 $ $Date: 2018/07/31 15:47:35CEST $                  */                    
/* $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTICANMM/Components/Blocks/BusSetup/project.pj $          */                 
/* ******************************************************************************************************/                 
                                                                                                                           
#define S_FUNCTION_LEVEL       2                                                                                           
#define S_FUNCTION_NAME        RTICANMM_SETUP_Controller1                                                                                          
...
#define CAN_BOARD_BASE                                  IP_TP1_1_MODULE_ADDR                                  
...
static Float64 CANMM_CTL_SETUP_Controller1_baudrate      = 500.0;                                                                                 
static Float64 CANMM_CTL_SETUP_Controller1_baudrate_in   = 500.0; /* Temporary for input port value */                                            
static Float64 CANMM_CTL_SETUP_Controller1_baudrate_old  = 500.0;                                                                                 
                                                                                                                            
static Float64 oldBusStat_TimeStamp = 0.0;                                                                                  
                                                                                                                            
static Float64 CANMM_CTL_SETUP_Controller1_baudrateFD      = 2000.0;                                                                           
static Float64 CANMM_CTL_SETUP_Controller1_baudrateFD_in   = 2000.0; /* Temporary for input port value */                                      
static Float64 CANMM_CTL_SETUP_Controller1_baudrateFD_old  = 2000.0;                                                                           
                                                                                                                        
#define SAMPLE_POINT                                        80.0                                                    
#define SAMPLE_POINT_FD                                     80.0                                                    
...
volatile UInt8 CANMM_CTL_SETUP_Controller1_ID;                                                                                              
volatile UInt8 CANMM_CTL_SETUP_Controller1_TX_STATUS                 = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_Controller1_Variation        = 1;                                                                   
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_Controller1_VariationSwitch  = 0;                                                                   
...
#endif                                                                                                           
volatile UInt8   CANMMMonitor_Controller1     = 0;                                                                                     
volatile UInt8   CANMMMonitor_Controller1_old = 0;                                                                                     
volatile dsfloat MonitoringTimeStamp_Controller1 = 0.0;                                                                                       
...
static CANMM_CTL_CLIENT_TYPE(CANMM_CTL_SETUP_Controller1) ctlsetup_client;                                                                
#endif /* RTICANMM_DSDAQ_SERVICEID */                                                                            
                                                                                                                 
                                                                                                                   
void                                                                                                               
CANMM_CTL_SETUP_Controller1_baudrate_set(Float64 baudrate) {                                                                                
  ...
  if ((Error = DsCanCh_apply(CanMM_channel)) != DSCAN_NO_ERROR)                                                    
    ...
    CANMM_CTL_SETUP_Controller1_baudrate = baudrate;                                                                                        
  }                                                                                                                
}                                                                                                                  
...
#if defined(RTICANMM_HAVE_VALID_PLATFORM)                                                                          
static SimStruct * RTICANMM_SETUP_Controller1_SimStruct = 0;                                                                               
void backgroundFunction_21143421()                                                                                       
{                                                                                                                  
  SimStruct *S = RTICANMM_SETUP_Controller1_SimStruct;                                                                                     
...
void DECLSPEC CANMM_CTL_SETUP_Controller1_client_init(CANMM_CTL_SETUP_Controller1_CtlClient* client) {                                                               
  ...
  if (!client->initialized) {                                                                                      
    ...
    if ((Error = DsCanMsg_setQueueSize(client->tx_msg, CANMM_CTL_SETUP_Controller1_tx_queue_size)) != DSCAN_NO_ERROR)                       
      CANMM_DEBUG_ERROR(Error);                                                                                    
#if (defined(DSCAN_VER_MAR) && DSCAN_VER_MAR == 1) || defined(RTICANMM_HAVE_DSRT)                                  
 ...
 * If CANMM_CTL_SETUP_Controller1_rx_stop has been issued before, the receive buffer (mcr) is cleared                                       
 ...
 * CANMM_CTL_SETUP_Controller1_rx function. To continue reception of messages CANMM_CTL_SETUP_Controller1_rx_start                                                   
 * has to be called.                                                                                               
 */                                                                                                                
...
Float64 DECLSPEC CANMM_CTL_SETUP_Controller1_baudrate_get() {                                                                               
  return CANMM_CTL_SETUP_Controller1_baudrate;                                                                                              
}                                                                                                                  
                                                                                                                   
Float64 DECLSPEC CANMM_CTL_SETUP_Controller1_baudrateFD_get() {                                                                             
  return CANMM_CTL_SETUP_Controller1_baudrateFD;                                                                                            
}                                                                                                                  
...
UInt32 DECLSPEC CANMM_CTL_SETUP_Controller1_tx_queue_level(CANMM_CTL_SETUP_Controller1_CtlClient* client) {                                                          
  ...
  if ((Error = DsCanMsg_getTxQueueCount(client->tx_msg, &tx_count)) != DSCAN_NO_ERROR) {                           
    ...
    tx_count = CANMM_CTL_SETUP_Controller1_tx_queue_size;                                                                                   
  }                                                                                                                
  return tx_count;                                                                                                 
}                                                                                                                  
...
#if defined(RTICANMM_HAVE_DSCAN_BUS)                                                                                       
  if ((Error = DsCanBus_create(&CanMM_vBus, 1)) != DSCAN_NO_ERROR)                                                
    CANMM_DEBUG_ERROR(Error);                                                                                      
...
# endif /* RTICANMM_HAVE_DSCAN_BUS */                                                                              
  ...
  if ((Error = DsCanCh_setDescriptor(CanMM_channel, "Controller1")) != DSCAN_NO_ERROR)                                      
    CANMM_DEBUG_ERROR(Error);                                                                                      
                                                                                                                   
  if ((Error = DsCanCh_setBaudRate(CanMM_channel, (int)CANMM_CTL_SETUP_Controller1_baudrate*1000)) != DSCAN_NO_ERROR)                   
      CANMM_DEBUG_ERROR(Error);                                                                                
                                                                                                               
  if ((Error = DsCanCh_setSamplePoint(CanMM_channel, ((Float32) SAMPLE_POINT)/100)) != DSCAN_NO_ERROR)     
      CANMM_DEBUG_ERROR(Error);                                                                            
  ...
  if ((Error = DsCanCh_setFeature(CanMM_channel, DSCAN_CH_FEATURE_FD_ON)) != DSCAN_NO_ERROR)              
     CANMM_DEBUG_ERROR(Error);                                                                            
                                                                                                          
  if ((Error = DsCanCh_setFeature(CanMM_channel, DSCAN_CH_FEATURE_FD_ISO_MODE)) != DSCAN_NO_ERROR)    
     CANMM_DEBUG_ERROR(Error);                                                                            
                                                                                                          
  if ((Error = DsCanCh_setBaudRateDataPhase(CanMM_channel, (CANMM_CTL_SETUP_Controller1_baudrateFD_old*1000))) != DSCAN_NO_ERROR)      
     CANMM_DEBUG_ERROR(Error);                                                                                
                                                                                                              
  if ((Error = DsCanCh_setSamplePointDataPhase(CanMM_channel, ((Float32) SAMPLE_POINT_FD)/100)) != DSCAN_NO_ERROR)
     CANMM_DEBUG_ERROR(Error);                                                                                
  ...
  if ((Error = DsCanCh_getBaudRate(CanMM_channel, &br_arb)) != DSCAN_NO_ERROR)                                    
    CANMM_DEBUG_ERROR(Error);                                                                                     
  else                                                                                                            
    msg_info_printf(MSG_SM_CANNEDY, 0, "CANMM_CTL_SETUP_Controller1: Baud rate arbitration phase: %d Kb/s", (br_arb/1000));                 
                                                                                                                  
  if ((Error = DsCanCh_getSamplePoint(CanMM_channel, &sp_arb)) != DSCAN_NO_ERROR)                                 
    CANMM_DEBUG_ERROR(Error);                                                                                     
  else                                                                                                            
    msg_info_printf(MSG_SM_CANNEDY, 0, "CANMM_CTL_SETUP_Controller1: Sample point arbitration phase: %.2f %%", sp_arb*100.0);              
                                                                                                                  
  if ((Error = DsCanCh_getBaudRateDataPhase(CanMM_channel, &br_dat)) != DSCAN_NO_ERROR)                           
    CANMM_DEBUG_ERROR(Error);                                                                                     
  else                                                                                                            
    msg_info_printf(MSG_SM_CANNEDY, 0, "CANMM_CTL_SETUP_Controller1: Baud rate data phase: %d Kb/s", (br_dat/1000));                        
                                                                                                                  
  if ((Error = DsCanCh_getSamplePointDataPhase(CanMM_channel, &sp_dat)) != DSCAN_NO_ERROR)                        
    CANMM_DEBUG_ERROR(Error);                                                                                     
  else                                                                                                            
    msg_info_printf(MSG_SM_CANNEDY, 0, "CANMM_CTL_SETUP_Controller1: Sample point data phase: %.2f %%", (sp_dat*100.0));                   
                                                                                                                  
  if(S != 0)                                                                                                      
       RTICANMM_SETUP_Controller1_SimStruct = S;                                                                                          
...
# endif                                                                                                            
#if defined(RTICANMM_DSDAQ_SERVICEID)																				  
    CANMM_CTL_CLIENT_INIT(CANMM_CTL_SETUP_Controller1, &ctlsetup_client);                                                                   
    CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_Controller1, &ctlsetup_client);      /* Start disabled */                                             
# endif                                                                                                            
...
/****************************/                                                                                     
  ...
  if(S != 0)                                                                                                       
      RTICANMM_SETUP_Controller1_SimStruct = S;     //just to be safe we do one more assigment                                             
#endif /* RTICANMM_HAVE_VALID_PLATFORM */                                                                          
}                                                                                                                          
#endif /*  MDL_START */                                                                                                    
...
#if defined(RTICANMM_DSDAQ_SERVICEID)                                                                            
if (CANMMMonitor_Controller1 > 0 && !(CANMMMonitor_Controller1_old > 0)) { /* monitoring enabled */                                                          
  CANMM_CTL_RX_START(CANMM_CTL_SETUP_Controller1, &ctlsetup_client);                                                                      
}                                                                                                                
if (!(CANMMMonitor_Controller1 > 0) && CANMMMonitor_Controller1_old > 0) { /* monitoring disabled */                                                         
  CANMM_CTL_RX_STOP(CANMM_CTL_SETUP_Controller1, &ctlsetup_client);                                                                       
}                                                                                                                
CANMMMonitor_Controller1_old = CANMMMonitor_Controller1;                                                                                                     
                                                                                                                 
if (CANMMMonitor_Controller1 > 0) {                                                                                                    
  while (CANMM_CTL_RX(CANMM_CTL_SETUP_Controller1, &ctlsetup_client, &canmm_msg)) {                                                       
    UInt32 i = 0;                                                                                                
    int j = 0, k = 0;                                                                                            
...
#endif                                                                                                           
    MonitoringTimeStamp_Controller1 = canmm_msg.TimeStamp;                                                                                    
  ...
  if (CANMM_CTL_SETUP_Controller1_VariationSwitch == 0) {                                                                                   
    CANMM_CTL_SETUP_Controller1_ID = INDEF_VARIATION;                                                                                       
  }                                                                                                                
  else {                                                                                                           
    CANMM_CTL_SETUP_Controller1_ID = CANMM_CTL_SETUP_Controller1_Variation;                                                                                          
  }                                                                                                                
...
/****************************/                                                                                     
  ...
  CANMMMonitor_Controller1_old = 0;                                                                                                      
  if ((Error = DsCanCh_stop(CanMM_channel)) != DSCAN_NO_ERROR)                                                     
    CANMM_DEBUG_ERROR(Error);                                                                                      
    RTICANMM_SETUP_Controller1_SimStruct = 0;                                                                                              
#endif   /* RTICANMM_HAVE_VALID_PLATFORM */                                                                        
}                                                                                                                          
