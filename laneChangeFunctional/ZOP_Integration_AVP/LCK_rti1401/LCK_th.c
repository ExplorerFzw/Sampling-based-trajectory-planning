/************************ dSPACE target specific file *************************
   ...
   Include file .\LCK_rti1401\LCK_th.c :

   Task Configuration file for model : LCK

   RTI1401 7.12 (02-May-2019)/2.18
   10-Feb-2021 09:08:45
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\LCK_rti1401\LCK_th.c is for ST).
# endif
