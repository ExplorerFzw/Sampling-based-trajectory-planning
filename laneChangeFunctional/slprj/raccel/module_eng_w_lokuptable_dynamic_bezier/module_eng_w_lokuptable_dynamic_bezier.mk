...
MODEL                  = module_eng_w_lokuptable_dynamic_bezier
MODULES                = rt_logging.c module_eng_w_lokuptable_dynamic_bezier.c module_eng_w_lokuptable_dynamic_bezier_capi.c module_eng_w_lokuptable_dynamic_bezier_data.c module_eng_w_lokuptable_dynamic_bezier_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = module_eng_w_lokuptable_dynamic_bezier.mk
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = module_eng_w_lokuptable_dynamic_bezier_ref.rsp
COMPILER_COMMAND_FILE     = module_eng_w_lokuptable_dynamic_bezier_comp.rsp
