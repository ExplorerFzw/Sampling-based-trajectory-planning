...
for long_S = 0:80
   [search_latoff,search_theta,search_kappa,trajs_new,theta] = LineGeneration(c0,c1,c2,c3,velocity,...
...
function [search_latoff,search_theta,search_kappa,trajs_new,delta_heading_rad] = LineGeneration(c0,c1,c2,c3,velocity,...
    indicator,Flag,P_lateral_offset,long_S,TIME)
