classdef ExampleHelperDifferentialDriveRobot < handle
    %EXAMPLEHELPERDIFFERENTIALDRIVEROBOT Create a simulated differential drive robot
    ...
    methods
        function obj = ExampleHelperDifferentialDriveRobot(currentPose)
